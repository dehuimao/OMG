	...
	public function _initialize() {
	 ...
	 public function reply(){
		...
		if(IS_POST){
			...
			if($info){
				$result = M('scene_reply')->where($where)->save($data);
				if($result){
					$this->success('操作成功');
				}else{
					$this->error('操作失败');
	 ...
	 public function index(){
		...
		if(IS_POST){
			...
			if($info){
				$result = M('scene')->where($where)->save($data);
				if($result){
					$this->success('操作成功');
				}else{
					$this->error('操作失败');
