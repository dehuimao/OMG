...
class MarketAction extends UserAction{
    ...
    public function _create_nav($id){
        ...
        $url = array('{siteUrl}/index.php?g=Wap&m=Market&a=tenant&token=' . $this -> token . '&wecha_id={$wecha_id}', '{siteUrl}/index.php?g=Wap&m=Market&a=park&token=' . $this -> token . '&wecha_id={$wecha_id}', '{siteUrl}/index.php?g=Wap&m=Market&a=intro&token=' . $this -> token . '&wecha_id={$wecha_id}', '{siteUrl}/index.php?g=Wap&m=Groupon&a=grouponIndex&token=' . $this -> token . '&wecha_id={wechat_id}',);
