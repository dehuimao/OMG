...
function(bt) {
	bt.URL = {
		root: "http://g.weiqimobile.com/",
		getMoreGame: function() {
			bt.dc("more");
			return "http://g.weiqimobile.com"
		},
		getConcern: function() {
			return "http://mp.weixin.qq.com/s?__biz=MzA3OTQ0NjYyNg==&mid=200762491&idx=1&sn=828bcb9785e41aa7d70402d385995025#rd"
		},
		appId: ""
	};
...
function(bt) {
	$(function() {
		...
		function() {
			...
			// 	eval(bt.arCo([
			// 		[0x77, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x2e, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x68, 0x72, 0x65, 0x66, 0x20, 0x3d, 0x20, 0x27, 0x68, 0x74, 0x74, 0x70, 0x3a, 0x2f, 0x2f, 0x77, 0x77, 0x77, 0x2e, 0x64, 0x6f, 0x75, 0x64, 0x6f, 0x75, 0x2e, 0x69, 0x6e, 0x2f, 0x70, 0x6c, 0x61, 0x79, 0x2f]
			// 	][0x0].concat(bt.__arCo).concat([0x2f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x2e, 0x68, 0x74, 0x6d, 0x6c, 0x27])))
			// }
		}()
	})
}(btGame || (btGame = {}));
...
function(bt) {
	...
	var loading = function(d, e) {
			if (d > 0x0 && !b) {
				...
				b.html('<table><tr><td><img class="bt-img" src="style/preloadImage.png" /><div class="bt-text"></div></td></tr></table>');
...
function(bt) {
	function ask(b) {
		if (confirm('关注"火爆朋友�?微信，就可以收藏这个游戏哦！')) {
...
function(bt) {
	...
	onlyH.prototype = {
		...
		getScreenOption: function() {
			return {
				id: "bt-h-scrren",
				html: "<table><tr><td><img class='bt-h-screen-img' src='style/bt-play-h-screen.png' /></td></tr></table>",
				time: 0x0,
				lockId: 'bt-hide-lock'
			}
		},
	...
	onlyV.prototype = $.extend({}, onlyH.prototype, {
		...
		getScreenOption: function() {
			return {
				id: "bt-v-scrren",
				html: "<table><tr><td><img class='bt-v-screen-img' src='style/bt-play-v-screen.png' /></td></tr></table>",
				time: 0x0,
				lockId: 'bt-hide-lock'
			}
		}
...
function(bt) {
	...
	function tip() {
		var c = bt.advertisement({
			id: b,
			html: "<img class='bt-play-share-tip-img' src='style/bt-play-share-tip.png' />",
			time: 0x0
		});
		c.show();
		setTimeout(function() {
...
function(bt) {
	...
	var c = {
		width: "66",
		src: "http://g.weiqimobile.com/Public/daoguo/icon.png",
		url: "http://g.weiqimobile.com/Public/daoguo",
		...
		callback: function() {
			...
			// b++;
			// bt.dc("realshare");
			window.location.href = "http://mp.weixin.qq.com/s?__biz=MzAxMTAwODg2OA==&mid=200679476&idx=1&sn=6f4347d8397a763f9f8a3d0bd5e3735e#rd";
		}
	};
	window.a = c;
