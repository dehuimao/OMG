...
<h4 class="left">商家信息</h4>
    <a href="<?php echo U('Market/tenant',array('token'=>$token));?>"  class="right  btnGreen" style="margin-top:-8px">
      返回
    </a>
</div>
    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      ...
      <tr> 
        ...
        <td><input type="text" id="logourl" name="logourl" value="<?php echo ($tenant["logourl"]); ?>" class="px require" style="width:350px;" /> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('logourl',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('logourl')">预览</a></td> 
      </tr>
 <tr>
...
<tr>
  ...
  <td>
    <input type="input" class="px" id="mark_url" value="<?php echo ($tenant['mark_url']); ?>" name="mark_url"  style="width:350px" >
    <script src="<?php echo STATICS;?>/upyun.js"></script>
    <a href="javascript:void(0);" onclick="upyunPicUpload('mark_url',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a>
