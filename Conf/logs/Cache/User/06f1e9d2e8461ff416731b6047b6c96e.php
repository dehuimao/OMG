	  ...
	  <form class="form" method="post" action="" target="_top" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				...
				<tr>
					<th>签到页头部图片：</th>
					<td><input type="text" name="top_pic" value="<?php echo ($set["top_pic"]); ?>" id="pic" class="px" style="width:550px;"> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a>   &nbsp; 大小为720x400<br>回复签到的时候出现的图文图片地址</td>
				</tr>
				<th>&nbsp;</th>
					<td>
