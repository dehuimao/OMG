...
<td><?php echo ($diningTable[$o['tableid']]['name']); ?></td>
...
function showIntroDetail(id){
	art.dialog.open('<?php echo U('Repast/orderInfo',array('token'=>$token,'dining'=>$isDining));?>&id='+id,{lock:false,title:'订单详情',width:1000,height:620,yesText:'关闭',background: '#000',opacity: 0.87});
}
</script>
</div>
<div class="cLine">
