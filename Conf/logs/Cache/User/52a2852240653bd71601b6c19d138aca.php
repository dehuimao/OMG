...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Live/add',array('token'=>$token));?>" title="添加场景" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加场景</a></div>
...
<?php if($item["show_company"] == '1'): ?><!--<a href="<?php echo U('Company/branches',array('id'=>$item['id'],'token'=>$token,'isBranch'=>1));?>">公司分支信息</a>-->
	<a href="<?php echo U('Live/company',array('id'=>$item['id'],'token'=>$token));?>">商家展示</a>
	|<?php endif; ?>
