...
<ul id="tags" style="width:100%">
		<li <?php if($tab == 'list'): ?>class="selectTag"<?php endif; ?>>
				<a href="?g=User&m=Router&a=index">路由器列表</a> 
			</li>
		<li <?php if($tab == 'config'): ?>class="selectTag"<?php endif; ?>>
				<a href="?g=User&m=Router&a=config">商家设置</a> 
			</li>
			
						<div class="clr" style="height:1px;background:#eee;margin-bottom:20px;"></div>
		</ul>
</div>
 <div class="ftip" style="margin:25px auto 5px auto;">下面填写粉丝上网时回复的图文消息和wifi登陆页使用的图片，如果没有图片就直接保存即可</div>
<div class="msgWrap">
...
<TABLE class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
  ...
  <tr>
				  ...
				  <td>
					<input type="text" name="keyword" value="<?php echo ($info["keyword"]); ?>" class="px" style="width:250px;"> 比如：我要上网</td>
				</tr>
				<tr>
				...
				<tr>
					<th>回复图片：</th>
					<td><input type="text" name="picurl" id="picurl" value="<?php echo ($info["picurl"]); ?>" class="px" style="width:550px;">   <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('picurl',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('picurl')">预览</a> 长360 宽200</td>
				</tr>
				<tr>
					<th width="120">回复简介：</th>
					<td><textarea style="width:560px;height:75px" name="info" id="info" class="px"><?php echo ($info["info"]); ?></textarea><br/>最多填写120个字</td>
				</tr>
 <TR>
  <TH valign="top"><label for="acttitle">上网密码：</label></TH>
  <TD><input type="password" class="px" id="password"  name="password" style="width:400px"  value="" > 六位字母或者数字，留空则不修改密码，仅当笔记本上网的时候用到</TD>
  <TD>&nbsp;</TD>
</TR>		
  <TR>
  <TH valign="top"><label for="acttitle">联系QQ：</label></TH>
  <TD><input type="input" class="px" id="contact_qq"  name="contact_qq" style="width:400px"  value="<?php echo ($info["contact_qq"]); ?>" ></TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
  <TH valign="top"><label for="acttitle">欢迎图片文件：</label></TH>
  <TD><input type="input" class="px" id="welcome_img"  name="welcome_img" style="width:400px"  value="<?php echo ($info["welcome_img"]); ?>" >  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('welcome_img',500,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('welcome_img')">预览</a>&nbsp;&nbsp;不上传就使用默认的  长606 宽360</TD>
  <TD>&nbsp;</TD>
</TR>
 <tr> 
        <th>成功图片文件：</th>
        <td><input type="text" name="other_img" value="<?php echo ($info["other_img"]); ?>" class="px" id="other_img" style="width:400px;" />  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('other_img',500,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('other_img')">预览</a>&nbsp;&nbsp;不上传就使用默认的  长606 宽360</td>
       </tr>
<TR>
  <TH></TH>
