...
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Repast/add',array('token' => $token,'cid'=>$cid));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加桌台</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<thead>
	<tr>
		...
		<th width="160">餐台名称</th>
        <th width="">店铺名称</th>
		<th width="60">类型</th>
		<th width="170">容纳人数</th>
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tablelist): $mod = ($i % 2 );++$i;?><tr>
		...
		<td class="norightborder">
			...
			<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Repast/del',array('id' => $tablelist['id'], 'token' => $token,'cid' => $tablelist['cid']));?>');">删除</a>
		</td>
