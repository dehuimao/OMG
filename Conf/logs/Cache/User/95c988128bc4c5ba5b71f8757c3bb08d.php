...
<div class="content">
<div class="cLineB">
  <h4>微场景回复信息配置 </h4><a href="javascript:history.go(-1);" class="right ChooseImage" style="margin-top:-27px">返回</a>
 </div>
<div class="tab">
<ul>
<li class="tabli" id="tab2"><a href="<?php echo U('Scene/index');?>">微场景设置</a></li>
<li class="current  tabli" id="tab20"><a href="<?php echo U('Scene/reply');?>">回复信息配置</a></li>
</ul>
</div>
		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
             <tr>
				  ...
				  <td><span class="red">微场景</span>————微信里输入关键字"微场景"即可看到效果
					</td>
				</tr>
            <tr>
                 ...
                 <tr>
					...
					<td><input type="text" id="picurl1" value="<?php echo ($info["tp"]); ?>" name="tp" class="px" style="width:550px;">  
                        ...
                        <a href="javascript:void(0)" onclick="upyunPicUpload('picurl1',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                        <a href="###" onclick="viewImg('picurl1')" class="ChooseImage">预览</a>
					</td>
				</tr>
				<tr>
