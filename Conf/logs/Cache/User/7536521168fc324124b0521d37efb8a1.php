...
<?php if($isUpdate == 1): ?><input type="hidden" name="id" value="<?php echo ($set["id"]); ?>" /><?php endif; ?>
    <div class="msgWrap bgfc"> 
     ...
     <tr> 
        ...
        <td><input type="text" name="pic" value="<?php echo ($set["pic"]); ?>" id="pic" class="px" style="width:400px;"  /> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,400,'<?php echo ($set["token"]); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('pic')" class="ChooseImage">预览</a>&nbsp;填写图片外链地址，大小为720x400</td> 
       </tr> 		
     <tr>
			<th valign="top"><label for="info">小秘密：</label></th>
            <td><textarea name="message"  id="text-content" rows="5" style="width:590px;height:360px"><?php echo ($set["message"]); ?></textarea></td>
        </tr>  
     <tr>         
       <th>&nbsp;</th>
       <td>
