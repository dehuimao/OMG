...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Vcard/add');?>" title="" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">添加名片</a></div>
<div class="clr"></div>
</div>
