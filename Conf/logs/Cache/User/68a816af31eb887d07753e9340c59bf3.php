...
<TR>
  ...
  <TD><input type="input" class="px" id="logo" value="<?php echo ($info["logo"]); ?>" name="logo" style="width:250px" value="" >  <a href="###" onclick="chooseFile('logo','my')" class="a_upload">选择</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('logo',400,400,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('logo')" class="a_upload">预览</a> 标题前面的logo,高度最佳80px，宽度最佳不超过200px，可以不填写
</TD>
</TR>

<TR>
  <TH valign="top"><label for="text">开幕背景：</label></TH>
  <TD><input type="input" class="px" id="startbackground" value="<?php echo ($info["startbackground"]); ?>" name="startbackground" style="width:250px" value="<?php echo ($info["startbackground"]); ?>" > <script src="/tpl/static/upyun.js"></script><a href="###" onclick="chooseFile('startbackground','background')" class="a_upload">选择</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('startbackground',1500,1000,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('startbackground')" class="a_upload">预览</a> 最佳尺寸宽984px,高636px
</TD>
</TR>
<TR>
  <TH valign="top"><label for="text">背景：</label></TH>
  <TD><input type="input" class="px" id="background" value="<?php echo ($info["background"]); ?>" name="background" style="width:250px" value="<?php echo ($info["background"]); ?>" > <script src="/tpl/static/upyun.js"></script><a href="###" onclick="chooseFile('background','background')" class="a_upload">选择</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('background',1500,1000,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('background')" class="a_upload">预览</a>  默认为空会有更好的显示效果
</TD>
</TR>
<TR>
...
<TR>
  ...
  <TD><input type="input" class="px" id="qrcode" value="<?php echo ($info["qrcode"]); ?>" name="qrcode" style="width:250px" value="" >  <a href="###" onclick="upyunPicUpload('qrcode',800,800,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('qrcode')" class="a_upload">预览</a>
</TD>
</TR>
<TR>
  <TH valign="top">状态：</TH>
...
<TR>
  ...
  <TD><input type="input" class="px" value="<?php echo ($info["firstprizename"]); ?>" name="firstprizename" style="width:250px" value="" ></td>
</TR>
<TR>
  <TH valign="top"><label for="text">一等奖数量：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["firstprizecount"]); ?>" name="firstprizecount" style="width:50px" value="" ></td>
</TR>
<TR>
  <TH valign="top"><label for="text">一等奖图片：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["firstprizepic"]); ?>" id="firstprizepic" name="firstprizepic" style="width:250px" value="" >  <a href="###" onclick="upyunPicUpload('firstprizepic',600,600,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('firstprizepic')" class="a_upload">预览</a></td>
</TR>


<TR>
  <TH valign="top"><label for="text">二等奖名称：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["secondprizename"]); ?>" name="secondprizename" style="width:250px" value="" ></td>
</TR>
<TR>
  <TH valign="top"><label for="text">二等奖数量：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["secondprizecount"]); ?>" name="secondprizecount" style="width:50px" value="" ></td>
</TR>
<TR>
  <TH valign="top"><label for="text">二等奖图片：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["secondprizepic"]); ?>" id="secondprizepic" name="secondprizepic" style="width:250px" value="" >  <a href="###" onclick="upyunPicUpload('secondprizepic',600,600,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('secondprizepic')" class="a_upload">预览</a></td>
</TR>

<TR>
  <TH valign="top"><label for="text">三等奖名称：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["thirdprizename"]); ?>" name="thirdprizename" style="width:250px" value="" ></td>
</TR>
<TR>
  <TH valign="top"><label for="text">三等奖数量：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["thirdprizecount"]); ?>" name="thirdprizecount" style="width:50px" value="" ></td>
</TR>
<TR>
  <TH valign="top"><label for="text">三等奖图片：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["thirdprizepic"]); ?>" id="thirdprizepic" name="thirdprizepic" style="width:250px" value="" >  <a href="###" onclick="upyunPicUpload('thirdprizepic',600,600,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('thirdprizepic')" class="a_upload">预览</a></td>
</TR>

<TR style="display:none">
  <TH valign="top"><label for="text">四等奖名称：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["fourthprizename"]); ?>" name="fourthprizename" style="width:250px" value="" ></td>
</TR>
<TR style="display:none">
  <TH valign="top"><label for="text">四等奖数量：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["fourthprizecount"]); ?>" name="fourthprizecount" style="width:50px" value="" ></td>
</TR>
<TR style="display:none">
  <TH valign="top"><label for="text">四等奖图片：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["fourthprizepic"]); ?>" id="fourthprizepic" name="fourthprizepic" style="width:250px" value="" >  <a href="###" onclick="upyunPicUpload('fourthprizepic',600,600,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('fourthprizepic')" class="a_upload">预览</a></td>
</TR>


<TR style="display:none">
  <TH valign="top"><label for="text">五等奖名称：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["fifthprizename"]); ?>" name="fifthprizename" style="width:250px" value="" ></td>
</TR>
<TR style="display:none">
  <TH valign="top"><label for="text">五等奖数量：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["fifthprizecount"]); ?>" name="fifthprizecount" style="width:50px" value="" ></td>
</TR>
<TR style="display:none">
  <TH valign="top"><label for="text">五等奖图片：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["fifthprizepic"]); ?>" id="fifthprizepic" name="fifthprizepic" style="width:250px" value="" >  <a href="###" onclick="upyunPicUpload('fifthprizepic',0,0,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('fifthprizepic')" class="a_upload">预览</a></td>
</TR>


<TR style="display:none">
  <TH valign="top"><label for="text">六等奖名称：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["sixthprizename"]); ?>" name="sixthprizename" style="width:250px" value="" ></td>
</TR>
<TR style="display:none">
  <TH valign="top"><label for="text">六等奖数量：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["sixthprizecount"]); ?>" name="sixthprizecount" style="width:50px" value="" ></td>
</TR>
<TR style="display:none">
  <TH valign="top"><label for="text">六等奖图片：</label></TH>
  <TD><input type="input" class="px" value="<?php echo ($info["sixthprizepic"]); ?>" id="sixthprizepic" name="sixthprizepic" style="width:250px" value="" >  <a href="###" onclick="upyunPicUpload('sixthprizepic',600,600,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('sixthprizepic')" class="a_upload">预览</a></td>
</TR>
