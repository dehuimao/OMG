	  ...
	  <form class="form" method="post" action="" target="_top" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
                ...
                <?php if($set and ($infoType["type"] == 'Shop')): ?><tr>
					<th>首页滚动图片：</th>
                 ...
                 <tr>
					<th></th>
					<td><input type="text" name="picurls2" value="<?php echo ($set["picurls2"]); ?>" id="pic2" class="px" style="width:550px;"> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic2',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic2')">预览</a>   &nbsp; 大小为720x400</td>
				</tr>
                  <tr>
					<th></th>
					<td><input type="text" name="picurls3" value="<?php echo ($set["picurls3"]); ?>" id="pic3" class="px" style="width:550px;"> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic3',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic3')">预览</a>   &nbsp; 大小为720x400</td>
				</tr>
                <tr>
					<th>版权设置：</th>
					<td><input name="copyright" value="<?php echo ($set["copyright"]); ?>" class="px" style="width:550px;" type="text"><br> 如：小猪CMS版权所有</td>
				</tr><?php endif; ?>
				<tr>
					<th>第三方接口：</th>
