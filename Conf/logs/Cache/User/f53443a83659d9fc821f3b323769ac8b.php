        ...
        <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
            <tbody>
                <tr>
                    ...
                    <input type="text"  name="area_addr" value="<?php echo ($student['area_addr']); ?>" id="tip"  class="px" size="50" placeholder="提示: 选择地区之后,填写该详细地址" data-validation-engine="validate[required]"   data-errormessage-value-missing="必须填写详细地址" /><span class="maroon">*</span>
                    <input type="text" class="px" value="<?php echo ($strdent['localdate_id']); ?>" name="localdate_id" hidden id="localdate_id">
                    <input type="text" class="px" value="<?php echo ($strdent['area']); ?>" name="area" hidden id="area_tip">
            ...
            linkageSel2.onChange(function() {
              ...
              localdate_id.val(arrid.join(','));
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" value="<?php echo ($student['s_name']); ?>" name="s_name" class="px" id="s_name" placeholder="请输入学员姓名"
                    ...
                    <td>
                    <input type="input" data-validation-engine="validate[required]"  data-errormessage-value-missing="出生日期必填" class="px" id="birthdate" value="<?php if($student['birthdate'] != ''): echo ($student['birthdate']); endif; ?>" onClick="WdatePicker()" name="birthdate">
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" name="homephone" id="homephone" value="<?php echo ($student['homephone']); ?>" class="px"
                    ...
                    <td>
                    <input type="text" name="mobile" id="mobile" value="<?php echo ($student['mobile']); ?>" data-validation-engine="validate[required,funcCall[checkTel]]"  class="px"placeholder="请输入联系人手机">
                    <span class="maroon">*</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                    <input type="input"  class="px" id="seffectivetime" value="<?php if($student['seffectivetime'] != ''): echo ($student['seffectivetime']); endif; ?>" onClick="WdatePicker()" name="seffectivetime">

                    </td>

                    <th width="120">终止时间:</th>
                    <td>
                    <input type="text" name="stheendtime"  class="px" id="stheendtime" value="<?php if($student['stheendtime'] != ''): echo ($student['stheendtime']); endif; ?>" onClick="WdatePicker()"  placeholder="请输入终止时间">
                 ...
                 <tr>
                    <th width="120">&nbsp;</th>
                    <td>
                   <!--  <input type="amount" name="" value="<?php echo ($student['amount']); ?>"  data-validation-engine="validate[required,custom[number],min[0.0]]" class="px" placeholder="请输入学费金额"> -->
                   <!-- <?php if($list['jf_statu'] == 1): ?><font color="green">已缴费</font><?php else: ?><font color="red">未缴费<?php endif; ?></font> -->
                    </td>

                    <th width="120">备注:</th>
                    <td>
                    <input type="text" name="note" id="note" value="<?php echo ($student['note']); ?>" class="px" placeholder="请输入备注">
                ...
                <th><?php if($student['id'] != ''): ?><input type="text" hidden name="id" value="<?php echo ($student['id']); ?>"><?php endif; ?></th>
                    <td>
                   <a href="<?php echo U('School/students',array('token'=>session('token')));?>" class="btnGray vm">取消</a>
                    </td>
                     <th></th>
                    <td>
...
<script src="<?php echo RES;?>/js/select/js/district-all.js"></script>
<script src="<?php echo RES;?>/js/select/js/district-level1.js"></script>
