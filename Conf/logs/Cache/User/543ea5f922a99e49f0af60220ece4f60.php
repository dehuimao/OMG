...
<li class="tabli current" id="tab2"><a href="<?php echo U('Dati/ktc');?>">看图猜列表</a></li>
<li class="tabli" id="tab2"><a href="<?php echo U('Dati/info');?>">游戏说明</a></li>
</ul>
</div>
<!--tab end-->
<div class="msgWrap">
...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Dati/add',array('type'=>0));?>" title="" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">添加选择题</a>
&nbsp;&nbsp;<a href="<?php echo U('Dati/add',array('type'=>1));?>" title="" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">添加简答题</a>&nbsp;&nbsp;<a href="<?php echo U('Dati/add',array('type'=>2));?>" title="" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">添加看图猜</a>
</div>
<div class="clr"></div>
</div>
...
<td><img src="<?php echo ($o["picurl"]); ?>" width="100px" height="100px" /></td>
<td><?php echo ($o["title"]); ?></td>
<td><?php echo ($o["daan"]); ?></td>
<td><?php echo ($o["score"]); ?></td>
<td class="norightborder"><a href="<?php echo U('Dati/edit',array('id'=>$o['id'],'type'=>$o['type']));?>">修改</a> <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Dati/delete',array('id'=>$o['id'],'type'=>$o['type']));?>');">删除</a></td>
