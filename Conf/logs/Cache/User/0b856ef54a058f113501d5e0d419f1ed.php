...
<div class="content">
<div class="cLineB">
	  <h4>当前位置：<a href="<?php echo U('Member_card/index',array('token'=>$token));?>">会员卡</a> >> <?php echo ($thisCard["cardname"]); ?>：会员卡通知</h4>
	  <a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
	</div>
<div class="cLine">
<div class="pageNavigator left"> <a href='/index.php?g=User&m=Member_card&a=noticeSet&id=<?php echo ($thisCard["id"]); ?>&token=<?php echo ($token); ?>' title='添加通知' class='btnGrayS vm bigbtn'>添加通知</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
