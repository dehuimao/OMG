...
<div class="content">
          ...
          <div class="cLine">
            ...
            <a href="<?php echo U('Car/add_saler',array('token'=>$token));?>" class="btnGrayS vm bigbtn" id="add_menu">
                    <img src="tpl/User/default/common/images/pic.png" class="vm">添加销售顾问
                </a>
            </div>
            <div class="clr"></div>
          </div>
          ...
          <form method="post" action="" id="info">
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
              <?php if(is_array($salers)): $i = 0; $__LIST__ = $salers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                      <td><img src="<?php echo ($vo['picture']); ?>" style="max-height:50px;"/></td>
                      <td><?php echo ($vo['name']); ?></td>
                      <td><?php echo ($vo['mobile']); ?></td>
                      <td><?php if($vo['salestype'] == 1): ?>售前<?php endif; if($vo['salestype'] == 2): ?>售后<?php endif; ?> <?php if($vo['salestype'] == 3): ?>售前/售后<?php endif; ?> </td>
                      <td><?php echo ($vo['sort']); ?></td>
                      <td class="input-medium">
                        <a class="btn" href="<?php echo U('Car/edit_salers',array('token'=>$token,'id'=>$vo['id']));?>" title="编辑">编辑</a>
                        <a class="btn" href="<?php echo U('Car/del_salers',array('token'=>$token,'id'=>$vo['id']));?>" title="删除" onclick="return(confirm('确定要删除吗？'))">删除</a>
