...
<?php if($ischild != 1): ?><div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-top:5px;"><b>订单支持无线打印，购买无线打印机（购买请直接联系<?php echo ($f_siteName); ?>）后便可以实现订单的自动打印</b><br>此处只显示总店信息，连锁店订单及菜品请进入相应平台进行管理，连锁店登录账号密码及登录地址请在LBS里设置查看</div><?php endif; ?>
<!--tab start-->
<div class="tab">
<ul>
