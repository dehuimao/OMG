...
<td width="430"><a href="<?php echo ($f_siteUrl); ?>/index.php/show/<?php echo (session('token')); ?>" target="ddd" title="点击查看推广页" class="green" target="_blank"><?php echo ($f_siteUrl); ?>/index.php/show/<?php echo (session('token')); ?></a></td>
...
<tr>
	...
	document.getElementById("gzhcopyright").innerHTML=document.getElementById("copyright").value;
		...
		<br/>
		<span>例如：© 2001-2013 <?php echo ($f_siteName); ?>版权所有</span>
		</td>
</tr>
<tr>
<td>&nbsp;</td>
...
<a href="<?php echo ($f_siteUrl); ?>/index.php/show/<?php echo (session('token')); ?>" class="right btnGray vm" target="ddd" style=" margin-right:20px" target="_blank">查看推广页</a>
</td>
</tr>
