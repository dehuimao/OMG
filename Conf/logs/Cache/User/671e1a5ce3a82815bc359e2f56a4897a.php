...
<div class="cLineB">
  <h4 class="left"><?php if($es_data['id'] != ''): ?>编辑<?php else: ?>添加<?php endif; ?>楼盘</h4>
  <a href="<?php echo U('Estate/index',array('token'=>$token));?>"  class="right  btnGreen">
    返回
  </a>
 </div>
...
<div class="control-group">
  <label for="keyword" class="control-label">首页幻灯片：</label>
  <div class="controls">
    <table class="quanjing" border="0" cellspacing="0" cellpadding="0" width="750">
        <tr id="slide">
          <td>
              <img id="slide1_src"  style="width:145px;" src="<?php echo ($es_data['slide1']); ?>">  
          </td>
          <td>
              <img id="slide2_src"  style="width:145px;" src="<?php echo ($es_data['slide2']); ?>">
          </td>
          <td>
              <img id="slide3_src"  style="width:145px;" src="<?php echo ($es_data['slide3']); ?>">
          </td>
          <td>
              <img id="slide4_src"  style="width:145px;" src="<?php echo ($es_data['slide4']); ?>">
          </td>
          <td>
              <img id="slide5_src"  style="width:145px;" src="<?php echo ($es_data['slide5']); ?>">
          </td>
        </tr>       
        <tr>
          <td>
            <input type="input" class="px" id="slide1" value="<?php echo ($es_data['slide1']); ?>" name="slide1" placeholder="幻灯片" style="width:133px">       
          </td>
          <td>
            <input type="input" class="px" id="slide2" value="<?php echo ($es_data['slide2']); ?>" name="slide2" placeholder="幻灯片" style="width:133px">            
          </td>
          <td>
            <input type="input" class="px" id="slide3" value="<?php echo ($es_data['slide3']); ?>" name="slide3" placeholder="幻灯片" style="width:133px">           
          </td>
          <td>
            <input type="input" class="px" id="slide4" value="<?php echo ($es_data['slide4']); ?>" name="slide4" placeholder="幻灯片" style="width:133px">       
          </td>
          <td>
            <input type="input" class="px" id="slide5" value="<?php echo ($es_data['slide5']); ?>" name="slide5" placeholder="幻灯片" style="width:133px">               
          </td>
        </tr>
       <tr>
          <td>
            <a href="javascript:void(0);" onclick="upyunPicUpload('slide1',480,720,'<?php echo ($token); ?>')" class="a_upload">上传</a>
            <a href="javascript:void(0);" onclick="viewImg('slide1')">预览</a>[480*720]         
          </td>
          <td>
            <a href="javascript:void(0);" onclick="upyunPicUpload('slide2',480,720,'<?php echo ($token); ?>')" class="a_upload">上传</a>
            <a href="javascript:void(0);" onclick="viewImg('slide2')">预览</a>[480*720]
          </td>
          <td>
            <a href="javascript:void(0);" onclick="upyunPicUpload('slide3',480,720,'<?php echo ($token); ?>')" class="a_upload">上传</a>
            <a href="javascript:void(0);" onclick="viewImg('slide3')">预览</a>[480*720]
          </td>
          <td>
            <a href="javascript:void(0);" onclick="upyunPicUpload('slide4',480,720,'<?php echo ($token); ?>')" class="a_upload">上传</a>
            <a href="javascript:void(0);" onclick="viewImg('slide4')">预览</a>[480*720]
          </td>
          <td>
            <a href="javascript:void(0);" onclick="upyunPicUpload('slide5',480,720,'<?php echo ($token); ?>')" class="a_upload">上传</a>
            <a href="javascript:void(0);" onclick="viewImg('slide5')">预览</a>[480*720]
          </td>
        </tr>        
    </table>
  </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                     <select id="res_id" name="res_id" class="input-medium" schoolSet>
                                        ...
                                        <span class="maroon">*</span>
                                        <span class="help-inline">如果没有，请先到<a href="<?php echo U('Estate/reservation',array('token'=>$token));?>" class="btn"><strong><font color='red'>预约管理</strong></font></a>添加</span>
                                    </div>
                                </div>
  <div class="control-group">
