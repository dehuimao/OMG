    ...
    <p><span class="bold">使用方法：</span>如果您的整体楼盘项目由多个子楼盘项目组成，请在此添加，如果没有可以不添加。</p>
          ...
          <div class="cLine">
            <div class="pageNavigator left">
                <a href="<?php echo U('Estate/housetype_add',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
                    <img src="tpl/User/default/common/images/pic.png" class="vm">添加户型
                </a>
            </div>
            <div class="clr"></div>
          </div>
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
             ...
             <tr>
                                            ...
                                            <th class="span3">操作</th>
                                                  ...
                                                  <tbody>
                                        <?php if($housetype == ''): ?><tr>
                                        <td colspan="6" style="text-align:center; height:30px;"><strong>没有任何户型信息.</strong></td>
                                        </tr>
                                    <?php else: ?>
                                    <?php if(is_array($housetype)): $i = 0; $__LIST__ = $housetype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        <td style="text-align:center; ;"><?php echo ($list['name']); ?></td>
                                        <td style="text-align:center; ;"><span class="label"> <?php echo (($list['title'])?($list['title']):"独立户型"); ?></span></td>
                                        <td style="text-align:center; "><?php echo ($list['sort']); ?></td>
                                        <td style="text-align:center; ">
                                        <a href="<?php echo U('Estate/housetype_add',array('id'=>$list['id'],'token'=>$list['token']));?>" class="btn">编辑</a>
                                        <a href="<?php echo U('Estate/housetype_del',array('id'=>$list['id'],'token'=>$list['token']));?>" onclick="return(confirm('确定要删除吗？'))" class="btn">删除</a></a>
                                        </td>
