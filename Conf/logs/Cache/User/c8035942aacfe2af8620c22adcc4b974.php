...
<div class="cLineB">
<h4>订单类型设置 [ 都是必填项 ]</h4>
<a href="<?php echo U('Host/lists',array('token'=>$token,'id'=>(int)$_GET['id']));?>" class="right btnGreen" style="margin-top:-27px">返回</a> </div>
...
<tr>
<th>订单类型：</th>
<td width="220"><input type="text" name="type" value="<?php echo ($list['type']); ?>" class="px" style="width:200px;">如:"标准房/商务套房"</td>
<th>简要说明：</th>
<td colspan="3"><input type="text" name="typeinfo" value="<?php echo ($list['typeinfo']); ?>" class="px" style="width:200px;"> 字尽量少，如“大床，双床，适合2人”</td>
</tr>
<tr>
<th>原价：</th>
<td><input type="text" name="price" value="<?php echo ($list['price']); ?>" class="px" style="width:200px;"></td>
<th>优惠价：</th>
<td colspan="3"><input type="text" name="yhprice" value="<?php echo ($list['yhprice']); ?>" class="px" style="width:200px;"></td>
</tr>
            <tr>
...
<tr>
                   ...
                   <th width="160">图片跳转地址以http://开头</th>
                        ...
                        <tr>
                            <td width="160"><input type="text" name="name" value="<?php echo ($list['name']); ?>" class="px" style="width:160px;"></td>                             
                            <td width="200"><input type="text" name="picurl" id="pic" value="<?php echo ($list['picurl']); ?>" class="px" style="width:160px;">   <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a></td>
                             <td width="200"><input type="text" name="url" value="<?php echo ($list['url']); ?>" class="px" style="width:160px;"></td>
...
<td valign="top" colspan="5"><textarea class="px" id="info" name="info" style="width: 600px; height: 180px; "><?php echo ($list['info']); ?></textarea></td>
</tr>
<tr><th width="100">&nbsp;</th>
<td><button type="submit" name="button" class="btnGreen">保存</button>
<a href="<?php echo U('Host/lists',array('token'=>$token,'id'=>$_GET['hid']));?>" class="btnGray vm">取消</a></td>
</tr>
</tbody></table>
