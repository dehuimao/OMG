...
<div class="content">
  ...
  <div class="cLineC" style="line-height: 32px;"> <a href="<?php echo U('Business/project_add',array('token'=>$token,'type'=>$type));?>" class="btnGrayS vm bigbtn">添加
...
<td><?php echo ($vo["oneprice"]); ?></td><?php endif; ?>
                    ...
                    <td>
              <a href="<?php echo U('Business/project_add',array('sid'=>$vo['sid'],'type'=>$vo['type']));?>" class="btnGreen">编辑</a>
              <a href="<?php echo U('Business/project_del',array('sid'=>$vo['sid'],'type'=>$vo['type']));?>" onclick="return(confirm('确定要删除吗？'))" class="btnGreen">删除</a>
                    </td>
