...
<UL id="tags">
              <LI <?php if($types == 1): ?>class="selectTag"<?php endif; ?>><A href="index.php?g=User&m=Invites&a=info&type=1&id=<?php echo ($_GET['id']); ?>&token=<?php echo ($_GET['token']); ?>">会议邀请</A> </LI>
              <LI <?php if($types == 2): ?>class="selectTag"<?php endif; ?>><A    href="index.php?g=User&m=Invites&a=info&type=2&id=<?php echo ($_GET['id']); ?>&token=<?php echo ($_GET['token']); ?>">聚会邀请</A> </LI>
               <LI <?php if($types == 3): ?>class="selectTag"<?php endif; ?>><A    href="index.php?g=User&m=Invites&a=info&type=3&id=<?php echo ($_GET['id']); ?>&token=<?php echo ($_GET['token']); ?>">活动邀请</A> </LI>
              <div class="clr"></div>
          </UL>
<DIV id=tagContent> 
...
<td> <input type="checkbox" name='del_id[]' value="239" class="checkitem"></td>
<td><?php echo ($vo["username"]); ?></td>
<td><div class="cateimg"><?php echo ($vo["telphone"]); ?></div></td>
<td><?php if($vo['rdo_go'] == 1): ?>是<?php else: ?>否<?php endif; ?></td>
<td><?php echo ($vo["content"]); ?></td>
<td class="norightborder">
	
	<a href="javascript:drop_confirm('您确定要删除吗?', 'index.php?g=User&m=Invites&a=info_del&type=<?php echo ($vo["type"]); ?>&id=<?php echo ($vo["id"]); ?>&token=<?php echo ($vo["token"]); ?>');">删除</a>
</td>
