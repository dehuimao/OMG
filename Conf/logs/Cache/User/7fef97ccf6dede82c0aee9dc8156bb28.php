...
<div class="content">
          ...
          <div class="cLine">
            <div class="pageNavigator left">
                <a href="<?php echo U('Car/addseries',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
                    <img src="tpl/User/default/common/images/pic.png" class="vm">添加车系
                </a>
            </div>
            <div class="clr"></div>
          </div>
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <?php if(is_array($series)): $i = 0; $__LIST__ = $series;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                     ...
                     <td class="input-medium">
                         <a class="btn" href="<?php echo U('Car/editseries',array('token'=>$token,'id'=>$vo['id']));?>" title="编辑">编辑</a>
                         <a class="btn"  onclick="return(confirm('确定要删除吗？'))" href="<?php echo U('Car/delseries',array('token'=>$token,'id'=>$vo['id']));?>" title="删除" >删除</a></td>
