		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			...
			<tbody>
                ...
                <tr>
					...
					<a href="#" onclick="upyunPicUpload('bg',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="#" onclick="viewImg('bg')">预览</a>   &nbsp; 大小为320x555</td>
					...
					<td><input type="text" name="picurls1" value="<?php echo ($set["picurls1"]); ?>" id="pic1" class="px" style="width:550px;"> <script src="/tpl/static/upyun.js"></script><a href="#" onclick="upyunPicUpload('pic1',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="#" onclick="viewImg('pic1')">预览</a>   &nbsp; 大小为190*50</td>
                ...
                <tr>
					...
					<td><input type="text" name="wx" value="<?php echo ($set["wx"]); ?>" id="wx" class="px" style="width:550px;"> <script src="/tpl/static/upyun.js"></script><a href="#" onclick="upyunPicUpload('wx',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="#" onclick="viewImg('wx')">预览</a>   &nbsp; <a href="http://wzweixiang.com/tpl/Wap/default/common/czz/images/c18.png">下载图标模板</a></td>

				</tr>
                 <TR>
                  <TH valign="top"><label for="url">更多内容链接：</label></TH>
                  <TD><input type="input" class="px" id="url" value="<?php echo ($set["url"]); ?>" name="url" style="width:280px;">  <a href="###" onclick="addLink('url',0)" class="a_choose">从功能库添加</a><br /><span class="red">如需跳转到其他网址，请在输入框右侧选择或这里填写网址(例如：http://baidu.com，记住如果填写必须有http://)</span>如果填写了图文详细内容，这里请留空，不要设置！</TD>
                </TR>
                <TR>
