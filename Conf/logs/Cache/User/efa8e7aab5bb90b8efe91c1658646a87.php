...
<div class="cLineB">
  <h4><a href="#">添加<?php if($type == 0): ?>选择题<?php elseif($type == 1): ?>简答题<?php else: ?>看图猜<?php endif; ?>题目</a> </h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div>
 <!--tab start-->
<div class="tab">
<ul>
