...
<div class="content">
  ...
  <div class="cLineC" style="line-height: 32px;"> <a href="<?php echo U('Business/poster_add',array('token'=>$token,'type'=>$type));?>" class="btnGrayS vm bigbtn">添加宣传海报</a> </div>
...
美容公司名称<?php endif; ?>
              ...
              <th style=" width:100px;">选用相册</th>
              <th style=" width:100px;">海报1</th>
              <th style=" width:100px;">海报2</th>
              <th style=" width:100px;">海报3</th>
              <th style=" width:100px;">海报4</th>
              <th style=" width:100px;">海报5</th>
              <th style=" width:120px;">操作</th>
            </tr>
          </thead>
          <tbody>
              <?php if(is_array($busines_pic)): $i = 0; $__LIST__ = $busines_pic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td><?php echo ($vo["0"]); ?></td>
                    <td><?php echo ($vo["1"]); ?></td>
                    <td><div class="cateimg"><img src="<?php echo ($vo["picurl_1"]); ?>" class="cateimg_small"></div></td>
                    <td><div class="cateimg"><?php if($vo["picurl_2"] != ''): ?><img src="<?php echo ($vo["picurl_2"]); ?>" class="cateimg_small"><?php endif; ?>
                    </div></td>
                    <td><div class="cateimg"><?php if($vo["picurl_3"] != ''): ?><img src="<?php echo ($vo["picurl_3"]); ?>" class="cateimg_small"><?php endif; ?></div></td>
                    <td><div class="cateimg"><?php if($vo["picurl_4"] != ''): ?><img src="<?php echo ($vo["picurl_4"]); ?>" class="cateimg_small"><?php endif; ?></div></td>
                    <td><div class="cateimg"><?php if($vo["picurl_5"] != ''): ?><img src="<?php echo ($vo["picurl_5"]); ?>" class="cateimg_small"><?php endif; ?></div></td>
                    <td>
              <a href="<?php echo U('Business/poster_add',array('pid'=>$vo['pid'],'type'=>$vo['type']));?>" class="btnGreen">编辑</a>
              <a href="<?php echo U('Business/poster_del',array('pid'=>$vo['pid'],'type'=>$vo['type']));?>" onclick="return(confirm('确定要删除吗？'))" class="btnGreen">删除</a>
                    </td>
