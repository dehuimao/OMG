...
$(document).ready(function(){
  ...
  <a href='<?php echo U('Guajiang/add',array('token'=>$token));?>' title='新增刮刮卡活动' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/img/activity-scratch-card.png" class="vm" />新增刮刮卡活动</a>
