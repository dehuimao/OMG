...
<TR>
  ...
  <TD>
	<input type="input" class="px" id="keyword" value="<?php if($vo['keyword'] == ''): ?>照片墙<?php else: echo ($vo["keyword"]); endif; ?>" name="keyword" style="width:400px" ><br />
  	<span class="red">只能写一个关键词</span>，用户输入此关键词将会触发此活动。
  </TD>
  <TD rowspan="7" valign="top">
	  <div style="margin-left:20px">
		<img id="starpicurl_src" src="<?php if($vo['starpicurl'] == ''): echo RES;?>/images/img/activity-zhaopianwall-start.jpg<?php else: echo ($vo["starpicurl"]); endif; ?>" width="373px" >	
		<br />
		<input class="px" id="starpicurl" name="starpicurl" value="<?php if($vo['starpicurl'] == ''): echo $f_siteUrl;?>/tpl/User/default/common/images/img/activity-zhaopianwall-start.jpg<?php else: echo ($vo["starpicurl"]); endif; ?>"    style="width:363px;">
<br>
 <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('starpicurl',1000,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('starpicurl')">预览</a>  
		填写活动开始图片网址
	  </div>
  </TD>
</TR>
<TR>
  ...
  <TD>
	<input type="input" class="px" id="title" value="<?php if($vo['title'] == ''): ?>照片墙活动开始了<?php else: echo ($vo["title"]); endif; ?>" name="title" style="width:400px" />
  	<br />
  	请不要多于50字!
  </TD>
  </TR>
 <TR>
  	<th valign="top"><span class="red">*</span>操作提示：</th>
  	<td><textarea class="px"   name="sttxt" style="width:400px"  ><?php if($vo['sttxt'] == ''): ?>请在公众账号聊天界面 切换到文字模式点击+选取照片，点击发送<?php else: echo ($vo["sttxt"]); endif; ?></textarea>
  		 </td>
</TR>
<TR>
...
<td><textarea  class="px" id="info" name="info"  style="width:400px; height:125px" ><?php if($vo['info'] == ''): ?>亲，请点击进入照片墙页面，晒晒更健康哦！<?php else: echo ($vo["info"]); endif; ?></textarea><br />换行请输入
 &lt;br&gt;
 </td>
</TR>
</TBODY>
  	...
  	<table class="userinfoArea" style=" margin: 0;" border="0" cellspacing="0" cellpadding="0" width="100%">
  		<tbody>
  			<tr>
  				...
  				<td><input type="input" class="px" id="endtite" value="<?php if($vo['endtite'] == ''): ?>照片墙活动已经结束了<?php else: echo ($vo["endtite"]); endif; ?>" name="endtite" style="width:400px" />
  					<br />
  					请不要多于50字! </td>
  				<td rowspan="4" valign="top"><div style="margin-left:20px"><img  id="endpicurl_src" src="<?php if($vo['endpicurl'] == ''): echo $f_siteUrl;?>/tpl/User/default/common/images/img/activity-zhaopianwall-end.jpg<?php else: echo ($vo["endpicurl"]); endif; ?>"  width="373px"/> <br />
  					<input class="px" id="endpicurl"  name="endpicurl" value="<?php if($vo['endpicurl'] == ''): echo $f_siteUrl;?>/tpl/User/default/common/images/img/activity-zhaopianwall-end.jpg<?php else: echo ($vo["endpicurl"]); endif; ?>"    style="width:363px;" >
<br>  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('endpicurl',1000,500,'<?php echo ($token); ?>')" class="a_upload">上传</a><a href="###" onclick="viewImg('endpicurl')">预览</a>  
  					填写活动结束图片网址 </div></td>
  				</tr>
  			<tr>
 ...
 &lt;br&gt;
  				...
  				<TR>
	<th valign="top">照片是否需要审核：</th>
	<td><input class="radio" type="radio" name="ischeck" value="1"  <?php if($vo['ischeck'] == 1): ?>checked<?php endif; ?> >是  <input class="radio" type="radio" name="ischeck" value="0"  <?php if($vo['ischeck'] == 0): ?>checked<?php endif; ?>>否</td> 
   </TR> 
  				<TR>
<th>&nbsp;</th>
<td><button type="submit" class="btnGreen" >保存</button>　<a href=""  class="btnGray vm">取消</a>　<span class="red">请确认功能管理已开启照片墙功能</span></td>
</TR>
  			</tbody>
  		</table>
  </div> 
