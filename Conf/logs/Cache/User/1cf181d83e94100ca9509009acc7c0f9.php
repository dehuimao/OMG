...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/cymain.css" />
        <div class="content">
<div class="cLineB">
<h4 class="left">场景内容</h4>
<a href="<?php echo U('Live/index',array('token'=>$token));?>"  class="right btnGrayS vm" >返回</a>
<div class="clr"></div>
</div>

<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Live/content_add',array('token'=>$token,'live_id'=>$live_id));?>" title="添加内容" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加内容</a></div>
<div class="searchbar right">
	<form method="post" action="">
		类型：
		<select name="type" id="">
			<option value="">请选择....</option>
			<option value="1">图片内容</option>
			<option value="2">视频内容</option>
		</select>
		<input type="text" id="msgSearchInput" class="txt" placeholder="输入关键词搜索" name="search" value="">
...
<th width="120">图片内容</th>
<th width="120">视频连接</th>
<th width="120">视频裁图</th>
<th width="40">类型</th>
<th width="40">是否显示</th>
 <th width="40">排序</th>
...
<td><a href="<?php echo ($item["bg_pic"]); ?>" target="_blank">点击查看图片</a></td>
<td><?php if($item["movie_link"] == ''): ?>无<?php else: ?><a href="<?php echo ($item["movie_link"]); ?>" target="_blank">点击查看视频内容</a><?php endif; ?></td>
<td><?php if($item["movie_pic"] == ''): ?>无<?php else: ?><a href="<?php echo ($item["movie_pic"]); ?>" target="_blank">点击查看视频图片</a><?php endif; ?></td> 
<td>	
	<?php if($item["type"] == '1'): ?>图片
...
<td class="norightborder">
	<a href="<?php echo U('Live/content_add',array('id'=>$item['id'],'token'=>$token,'live_id'=>$live_id));?>">修改</a>
	|
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Live/content_del',array('id'=>$item['id'],'token'=>$token,'live_id'=>$live_id));?>');">删除</a></td>
