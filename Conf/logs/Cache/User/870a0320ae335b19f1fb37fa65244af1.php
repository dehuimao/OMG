...
<a class="btn" href="<?php echo U('School/del_item',array('token'=>$token,'id'=>$list['id'],'deltype'=>'scoresearch'));?>" onclick="return(confirm('确定要删除吗？'))"  title="删除"><font color="#CCC7C7">删除</font></a>
</TD>
