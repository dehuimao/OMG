...
<?php if($is_scene > 0): ?><a href=""  title="微现场投票" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/text.png" class="vm">微现场投票</a><?php endif; ?>
            <?php else: ?>
            <a href="<?php echo U('Vote/add',array('type'=>'text'));?>"  title="发起文字投票" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/text.png" class="vm">发起文字投票</a>　<a href="<?php echo U('Vote/add',array('type'=>'img'));?>" title="发起图片投票" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/pic.png" class="vm">发起图片投票</a>
