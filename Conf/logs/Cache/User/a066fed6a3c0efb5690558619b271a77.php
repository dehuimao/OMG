...
<script src="/tpl/static/jquery.js"></script>
...
<div class="content">
<div class="cLineB">
  <h4>微场景设置 </h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div>
<div class="tab">
<ul>
<li class="current tabli" id="tab2"><a href="<?php echo U('Scene/index');?>">微场景设置</a></li>
<li class="tabli" id="tab20"><a href="<?php echo U('Scene/reply');?>">回复信息配置</a></li>
</ul>
</div>
    <div class="msgWrap bgfc">
	  <form class="form" method="post" action="" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
             <tr> 
        <th ><span class="red">*</span>微场景模板选择：</th> 
        <td> <select name="type" id="auth2nd"  class="input-medium">
               <option value="1" <?php if(($info["type"]) == "1"): ?>selected="selected"<?php endif; ?>>动态展示场景（需要设置5篇场景）</option>
               <option value="2" <?php if(($info["type"]) == "2"): ?>selected="selected"<?php endif; ?>>擦出效果场景（只需要设置背景图片）</option>
           ...
           <tr>
					<th>背景音乐：</th>
					<td>
				    <table><tr><?php if($info["musicurl"] != ''): ?><td><a id="musicurl_src" class="audio {skin:'blue'}" href="<?php echo ($info["musicurl"]); ?>">音乐播放</a></td><?php endif; ?>
					<td><input class="px" name="musicurl" value="<?php echo ($info["musicurl"]); ?>" id="musicurl" style="width:550px;" onchange="$('#musicurl_src').attr('href',this.value">
					<a href="###" onclick="upyunPicUpload('musicurl',0,0,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>&nbsp;<a href="###" onclick="chooseFile('musicurl','music')" class="ChooseImage">选择</a></td></tr></table>
					</td>
				</tr>				
                 <tr>
                    ...
                    <a href="javascript:void(0)" onclick="upyunPicUpload('p1',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p1')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th>第一篇图片②：</th>
					<td><input type="text" id="p2" value="<?php echo ($info["p2"]); ?>" name="p2" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p2',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p2')" class="ChooseImage">预览</a>
					</td>
				</tr>
                <tr>
					<th><span style="color:red">第二篇背景图片①：</span></th>
					<td><input type="text" id="p3" value="<?php echo ($info["p3"]); ?>" name="p3" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p3',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p3')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th>第二篇图片②：</th>
					<td><input type="text" id="p4" value="<?php echo ($info["p4"]); ?>" name="p4" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p4',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p4')" class="ChooseImage">预览</a>
					</td>
				</tr>
                <tr>
					<th>第二篇图片③：</th>
					<td><input type="text" id="p5" value="<?php echo ($info["p5"]); ?>" name="p5" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p5',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p5')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th>第二篇图片④：</th>
					<td><input type="text" id="p20" value="<?php echo ($info["p20"]); ?>" name="p20" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p20',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p20')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th><span style="color:red">第三篇背景图片①：</span></th>
					<td><input type="text" id="p6" value="<?php echo ($info["p6"]); ?>" name="p6" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p6',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p6')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th>第三篇图片②：</th>
					<td><input type="text" id="p7" value="<?php echo ($info["p7"]); ?>" name="p7" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p7',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p7')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th>第三篇图片③：</th>
					<td><input type="text" id="p8" value="<?php echo ($info["p8"]); ?>" name="p8" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p8',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p8')" class="ChooseImage">预览</a>
					</td>
				</tr>
                  <tr>
					<th><span style="color:red">第四篇背景图片①：</span></th>
					<td><input type="text" id="p9" value="<?php echo ($info["p9"]); ?>" name="p9" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p9',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p9')" class="ChooseImage">预览</a>
					</td>
				</tr>
                  <tr>
					<th>第四篇图片②：</th>
					<td><input type="text" id="p10" value="<?php echo ($info["p10"]); ?>" name="p10" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p10',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p10')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th>第四篇图片③：</th>
					<td><input type="text" id="p11" value="<?php echo ($info["p11"]); ?>" name="p11" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p11',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p11')" class="ChooseImage">预览</a>
					</td>
				</tr>
                  <tr>
					<th>第四篇图片④：</th>
					<td><input type="text" id="p12" value="<?php echo ($info["p12"]); ?>" name="p12" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p12',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p12')" class="ChooseImage">预览</a>
					</td>
				</tr>
                  <tr>
					<th><span style="color:red">第五篇背景图片①：</span></th>
					<td><input type="text" id="p13" value="<?php echo ($info["p13"]); ?>" name="p13" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p13',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p13')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th>第五篇图片②：</th>
					<td><input type="text" id="p14" value="<?php echo ($info["p14"]); ?>" name="p14" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p14',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p14')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th>第五篇图片③：</th>
					<td><input type="text" id="p15" value="<?php echo ($info["p15"]); ?>" name="p15" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p15',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p15')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th>第五篇图片④：</th>
					<td><input type="text" id="p16" value="<?php echo ($info["p16"]); ?>" name="p16" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p16',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p16')" class="ChooseImage">预览</a>
					</td>
				</tr>
                  <tr>
					<th><span style="color:red">第六篇背景图片①：</span></th>
					<td><input type="text" id="p17" value="<?php echo ($info["p17"]); ?>" name="p17" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p17',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p17')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th>第六篇图片②：</th>
					<td><input type="text" id="p18" value="<?php echo ($info["p18"]); ?>" name="p18" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p18',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p18')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th>第六篇图片③：</th>
					<td><input type="text" id="p19" value="<?php echo ($info["p19"]); ?>" name="p19" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p19',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p19')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th>第六篇图片④：</th>
					<td><input type="text" id="p21" value="<?php echo ($info["p21"]); ?>" name="p21" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p21',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p21')" class="ChooseImage">预览</a>
					</td>
				</tr>
                              <tr>
					<th>第六篇图片⑤：</th>
					<td><input type="text" id="p22" value="<?php echo ($info["p22"]); ?>" name="p22" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p22',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p22')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th><span style="color:red">第七篇背景图片①：</span></th>
					<td><input type="text" id="p23" value="<?php echo ($info["p23"]); ?>" name="p23" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p23',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p23')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th><span style="color:red">第八篇背景图片①：</span></th>
					<td><input type="text" id="p24" value="<?php echo ($info["p24"]); ?>" name="p24" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p24',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p24')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th><span style="color:red">第九篇背景图片①：</span></th>
					<td><input type="text" id="p25" value="<?php echo ($info["p25"]); ?>" name="p25" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p25',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p25')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th><span style="color:red">第十篇背景图片①：</span></th>
					<td><input type="text" id="p26" value="<?php echo ($info["p26"]); ?>" name="p26" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p26',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p26')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th><span style="color:red">第十一篇背景图片①：</span></th>
					<td><input type="text" id="p27" value="<?php echo ($info["p27"]); ?>" name="p27" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p27',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p27')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th>链接提示文字：</th>
                 ...
                 <tr>
					<th>跳转地址：</th>
					<td><input type="text" id="tipurl" value="<?php echo ($info["tipurl"]); ?>" name="tipurl" class="px" style="width:550px;">  <a href="###" onclick="addLink('tipurl',0)" class="ChooseImage">从功能库添加</a>
					</td>
				</tr>
                 <tr>
					<th><span style="color:red">第十二篇背景图片①：</span></th>
					<td><input type="text" id="p28" value="<?php echo ($info["p28"]); ?>" name="p28" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p28',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p28')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th>地址：</th>
                 ...
                 <tr>
					...
					<td><input type="text" id="p29" value="<?php echo ($info["p29"]); ?>" name="p29" class="px" style="width:550px;">  <a href="javascript:void(0)" onclick="upyunPicUpload('p29',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
                    <a href="###" onclick="viewImg('p29')" class="ChooseImage">预览</a>
					</td>
				</tr>
                 <tr>
					<th>分享提示语：</th>
