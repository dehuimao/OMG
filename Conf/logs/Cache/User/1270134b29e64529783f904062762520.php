...
<div class="content">
          <div class="cLineB">
              <h4 class="left">预约管理</h4><!--a href="javascript:history.go(-1);return false;" class="right btnGrayS vm" style="margin-top:-5px">返回</a-->
          </div>

          <div class="cLine">
    <div class="alert">
    <p><span class="bold">使用方法：预约试驾和预约保养添加一项即可。</span> <a class="btn" href="javascript:location.reload()">刷新</a></p>
    </div>
</div>
        ...
        <a href="<?php echo U('Car/add_res',array('token'=>$token,'addtype'=>'drive'));?>" class="btnGrayS vm bigbtn">
                    <img src="tpl/User/default/common/images/pic.png" class="vm">添加预约试驾
                </a> &nbsp;&nbsp;&nbsp;<?php endif; ?>
             <?php if($maintain_count == 1): else: ?>
            <a href="<?php echo U('Car/add_res',array('token'=>$token,'addtype'=>'maintain'));?>" class="btnGrayS vm bigbtn">
                    <img src="tpl/User/default/common/images/pic.png" class="vm">添加预约保养
                </a><?php endif; ?>
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                <?php if(is_array($reslist)): $i = 0; $__LIST__ = $reslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td >
                             <a href="<?php echo U('Car/res_manage',array('token'=>$vo['token'],'id'=>$vo['id'],'addtype'=>$vo['addtype']));?>" class="btn" title="订单管理">订单管理</a>
                            <a class="btn" href="<?php echo U('Car/res_edit',array('token'=>$vo['token'],'id'=>$vo['id'],'addtype'=>$vo['addtype']));?>" title="编辑">编辑</a> 
                             <a class="btn" href="<?php echo U('Car/res_del',array('token'=>$vo['token'],'id'=>$vo['id'],'addtype'=>$vo['addtype']));?>" onclick="return(confirm('确定要删除吗？'))"  title="删除">删除</a></td>
