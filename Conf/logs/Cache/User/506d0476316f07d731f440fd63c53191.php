...
<TR>
  ...
  <TD><input type="input" class="px" id="backgroundmusic" value="<?php echo ($info["backgroundmusic"]); ?>" name="backgroundmusic" style="width:250px" value="" >  <a href="###" onclick="chooseFile('backgroundmusic','music')" class="a_upload">选择</a> 定义大屏幕背景音乐，为URL地址
