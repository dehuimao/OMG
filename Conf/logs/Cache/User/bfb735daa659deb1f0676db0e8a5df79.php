...
<div class="content">
  <div class="cLineB">
    ...
    <a href="<?php echo U('Market/area',array('token'=>$token));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
  </div>
...
<table class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellspacing="0" cellpadding="0" width="100%">
 <tbody>
      <tr>
            ...
            <td><input type="input" class="px" id="area_name" value="<?php echo ($area['area_name']); ?>" name="area_name" style="width:400px">
              <br>
            </td>
            <td></td>
      </tr>
<tr>
  ...
  <td><input type="input" class="px" id="manage" value="<?php echo ($area['manage']); ?>" name="manage" style="width:400px">
  </td>
  <td></td>
</tr> 
<tr>
...
<tr>
  ...
  <td><input type="input" class="px" id="sort" value="<?php if($area['sort'] == 0): ?>50<?php else: echo ($area['sort']); endif; ?>" name="sort" style="width:200px">
  </td>
  <td></td>
</tr>  
...
<tr>
  ...
  <td>
    <input type="input" class="px" id="area_pic" value="<?php echo ($area['area_pic']); ?>" name="area_pic"  style="width:350px" >
    <script src="<?php echo STATICS;?>/upyun.js"></script>
    <a href="javascript:void(0);" onclick="upyunPicUpload('area_pic',320,220,'<?php echo ($token); ?>')" class="a_upload">上传</a>
