...
<div class="content">
          ...
          <div class="cLineB">
              <h4 class="left">当前位置：<a href="<?php echo U('Member_card/index',array('token'=>$token));?>">会员卡</a> >> <a href="<?php echo U('Member_card/index',array('token'=>$token));?>"><?php echo ($thisCard["cardname"]); ?></a> >> <a href="/index.php?g=User&m=Member_card&a=<?php echo ($a); ?>&token=<?php echo ($token); ?>&id=<?php echo ($thisCard["id"]); ?>"><?php echo ($thisItem["title"]); ?></a> >> 使用统计</h4>
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><tr>
					  ...
					  <td><?php echo ($c["userTel"]); ?></td>
					  <td><?php echo ($c["expense"]); ?></td>
					  <td><?php echo ($c["operName"]); ?></td>
					  <td><nobr><?php echo (date('Y-m-d H:i:s',$c["time"])); ?></nobr></td>
					  <td class="norightborder"><a href="javascript:drop_confirm('您确定要删除吗?','<?php echo U('Member_card/useRecord_del',array('itemid'=>$c['id'],'id'=>$thisCard['id']));?>');">删除</a>
					  </td>
