...
$(document).ready(function(){
  ...
  <a href='<?php echo U('Coupon/add',array('token'=>$token));?>' title='新增优惠券' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/img/activity-scratch-card.png" class="vm" />新增优惠券</a>
