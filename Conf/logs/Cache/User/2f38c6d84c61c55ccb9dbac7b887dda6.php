...
<script>
    ...
    function checkTel(field,rules,i,options){
         var regex = /^(13[0123456789]{1}\d{8}$|^15[1235689]{1}\d{8}$|^18[256789]{1}\d{8})|(0[0-9]{1,3}\-?[0-9]{7,8})$/;
        if(field.val() == null || !regex.test(field.val())){
...
<div class="content">
<div class="cLineB">
<h4>当前位置：微学校 >> <a href="<?php echo U('School/assess',array('token'=>$token));?>">教师管理</a> >> <?php if($type == 'edit'): ?>编辑<?php else: ?>新增<?php endif; ?>教师</h4>
 </div>
      ...
      <form class="form" id="formID" method="post" action="" target="_top" enctype="multipart/form-data">
        ...
        <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
                    ...
                    <td>
                    <input type="text" value="<?php echo ($s_teachers['tname']); ?>" id="tname" name="tname" class="px" placeholder="请输入教师姓名" data-validation-engine="validate[required,minSize[2]]"
                    ...
                    <td>
                    <input type="input" data-validation-engine="validate[required]" placeholder="出生日期必填" data-errormessage-value-missing="出生日期必填" class="px" id="birthdate" value="<?php if($s_teachers['birthdate'] != ''): echo ($s_teachers['birthdate']); endif; ?>" onClick="WdatePicker()" name="birthdate">
                    <span class="maroon">*</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" name="homephone" id="homephone" value="<?php echo ($s_teachers['homephone']); ?>" class="px"
                    ...
                    <td>
                    <input type="text" name="mobile" id="mobile" value="<?php echo ($s_teachers['mobile']); ?>" class="px"placeholder="请输入联系人手机" data-validation-engine="validate[required,funcCall[checkTel]]" >
                    <span class="maroon">*</span>
                    </td>
                </tr>
                 ...
                 <tr>
                    ...
                    <td>
                    <input value="<?php echo ($s_teachers['email']); ?>" placeholder="请输入电子邮件"  data-validation-engine="validate[required,custom[email]]"  class="px" type="text" name="email" id="email" />
                    </select>
                    <span class="maroon">*</span>
                    </td>
                   ...
                   <select name="sex" id="sex"  data-validation-engine="validate[required]"  data-errormessage-value-missing="必须选择性别">
                      ...
                      <option value="1" <?php if($s_teachers['sex'] == 1): ?>selected<?php endif; ?>>男</option>
                      <option value="2" <?php if($s_teachers['sex'] == 2): ?>selected<?php endif; ?>>女</option>
                    </select>
                    <span class="maroon">*</span>
                    </td>
                </tr>
                 ...
                 <tr>
                    ...
                    <td>
<?php if($s_teachers['faceimg'] != ''): ?><img class="thumb_img" id="faceimg_src" src="<?php echo ($s_teachers['faceimg']); ?>" style="max-height:100px;"><?php endif; ?>
                         <input type="input" class="px" id="faceimg" value="<?php echo ($s_teachers['faceimg']); ?>" name="faceimg" data-validation-engine="validate[required,custom[url]]"
                    data-errormessage-value-missing="必须上传回复图片!"  data-errormessage-custom-error="正确的网址,如: http://www.baidu.com/images/demo.png" >

                         <span class="help-inline">
                              <a href="###" onclick="upyunPicUpload('faceimg',270,300,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('faceimg')">预览</a>
                    ...
                    <td>
                    <input type="text" name="jiontime" id="jiontime" class="px" data-validation-engine="validate[required]" placeholder="入职时间必填" data-errormessage-value-missing="入职时间必填" class="px"  value="<?php if($s_teachers['jiontime'] != ''): echo ($s_teachers['jiontime']); endif; ?>" onClick="WdatePicker()">
                    <span class="maroon">*</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="4">
                    <textarea name="headinfo" id="headinfo" style="width: 650px; height: 70px; border:1px solid #234; "data-validation-engine="validate[required,minSize[2],maxSize[100]]" placeholder="不能超过100个字" data-errormessage-value-missing="必须填写"><?php echo ($s_teachers['headinfo']); ?></textarea>
                    <span class="maroon">*</span>
                    </td>
                </tr>
                 <tr>
                    ...
                    <td colspan="4">
                    <input type="input" class="px" id="sort" value="<?php echo (($comments['sort'])?($comments['sort']):1); ?>" name="sort"  data-validation-engine="validate[required,custom[integer],min[1]]" data-errormessage-value-missing="必填项">
              数字越大,越在前面显示.
                    <span class="maroon">*</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="4">
                    <textarea name="info" id="info" style="width: 105px; height: 370px; " data-validation-engine="validate[required]"  data-errormessage-value-missing="必须填写"><?php echo ($s_teachers['info']); ?></textarea>
                    <span class="maroon">*</span>
                    </td>
                </tr>
                ...
                <tr>
                   <th><?php if($s_teachers['tid'] != ''): ?><input type="text" hidden name="tid" value="<?php echo ($s_teachers['tid']); ?>"><?php endif; ?></th>
                    <td>
                   <a href="<?php echo U('School/assess',array('token'=>session('token')));?>" class="btnGray vm">取消</a>
