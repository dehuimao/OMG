...
<!--活动开始-->
<div class="cLineB">
    <h4>场景内容<?php if($info.id): ?>添加<?php else: ?>修改<?php endif; ?></h4>
    <a href="<?php echo U('Live/content',array('token'=>$token,'id'=>$live_id));?>"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a>
</div>
...
<TR>
  ...
  <TD>
  <input type="input" class="px" id="name" value="<?php echo ($info["name"]); ?>" name="name" style="width:320px" />
    请不要多于50字!
  </TD>
</TR>
...
<tr>
  ...
  <td>
    <input type="radio" name="type" class="type" value="1" <?php if($info["type"] != '2'): ?>checked<?php endif; ?>>图片内容&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="type" class="type" value="2" <?php if($info["type"] == '2'): ?>checked<?php endif; ?>>视频内容&nbsp;&nbsp;&nbsp;  （选择视频内容后页面上部分显示内容图片，下部分显示视频图片内容）
  </td>
</tr>
...
<tr>
  ...
  <td>
      <input class="px"  name="bg_pic" value="<?php echo ($info["bg_pic"]); ?>" id="pic1" style="width:320px;"  />
...
<tr id="mv">
  ...
  <td>
    <input class="px"  name="movie_link" value="<?php echo ($info["movie_link"]); ?>" id="mv1" style="width:320px;"  />
      <script src="/tpl/static/upyun.js"></script>
        <a href="###" onclick="upyunPicUpload('movie_link',640,990,'<?php echo ($token); ?>')" class="a_upload">上传</a> 
...
<tr id="mv_pic">
  ...
  <td>
    <input class="px"  name="movie_pic" value="<?php echo ($info["movie_pic"]); ?>" id="pic2" style="width:320px;"  />
      <script src="/tpl/static/upyun.js"></script>
