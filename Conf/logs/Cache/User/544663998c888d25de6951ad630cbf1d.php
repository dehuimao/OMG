...
.span4, .span1, .option, .valid, .input-large{
	background: url(<?php echo RES;?>/images/px.png) repeat-x scroll 0 0 #FFFFFF;
...
#tags {
	MARGIN: 15px 0 0 0; WIDTH: 990px; PADDING-TOP: 0px; HEIGHT: 40px;BACKGROUND: url(<?php echo RES;?>/images/tagbg.gif) repeat-x left bottom;
}
#tags LI {
	BACKGROUND: url(<?php echo RES;?>/images/tagleft.gif) no-repeat left bottom; FLOAT: left; MARGIN-RIGHT: 3px; LIST-STYLE-TYPE: none; HEIGHT: 40px
}
#tags LI A {
	PADDING:0 20px; BACKGROUND: url(<?php echo RES;?>/images/tagright.gif) no-repeat right bottom; FLOAT: left; COLOR: #999; LINE-HEIGHT: 40px; HEIGHT: 40px; TEXT-DECORATION: none; font-size:16px;
}
#tags LI.emptyTag {
...
<div class="cLineB">
  <h4>微喜帖信息列表</h4>
  <a href="index.php?ac=WeddingInvitation-List&amp;id=9878" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div>
 <div class="msgWrap form">
 <ul id="tags">
			
              <li <?php if($type == 1): ?>class="selectTag"<?php endif; ?>><a href="<?php echo U('Wedding/info',array('id'=>strip_tags($_GET['id']),'type'=>1));?>">赴宴名单</a> </li>
			
              <li <?php if($type == 2): ?>class="selectTag"<?php endif; ?>><a href="<?php echo U('Wedding/info',array('id'=>strip_tags($_GET['id']),'type'=>2));?>">收到祝福</a> </li>
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
			  ...
			  <?php if(is_array($wedding)): $i = 0; $__LIST__ = $wedding;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wedding): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td class="norightborder">
					<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('User/Wedding/infodel',array('id'=>$wedding['id']));?>');">删除</a>
				   </td>
