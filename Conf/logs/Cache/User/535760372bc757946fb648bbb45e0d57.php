...
<script src="/tpl/static/artDialog/plugins/iframeTools.js"></script>
  <div class="content"> 
   <div class="cLineB"> 
    <h4><span class="red"><?php echo ($catData["name"]); ?></span>的分类<?php if($type == 1): ?>外观<?php else: ?>规格<?php endif; ?>值得设置</h4> 
    <a href="<?php echo U('Store/norms',array('token'=>$token,'catid'=>$catid, 'type' => $type));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
   <form class="form" method="post" action="" enctype="multipart/form-data"> 
    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      ...
      <?php if($type == 1): ?><tr> 
        <th>外观名称：</th> 
        <td><?php echo ($catData["color"]); ?></td> 
       </tr>
       <?php else: ?>
       <tr> 
        <th>规格名称：</th> 
        <td><?php echo ($catData["norms"]); ?></td> 
       </tr><?php endif; ?>
       <tr>
        <th><span class="red">*</span><?php if($type == 1): ?>外观<?php else: ?>规格<?php endif; ?>属性值：</th> 
        <td><input type="text" name="value" value="<?php echo ($set["value"]); ?>" class="px"/></td> 
       </tr>
       <tr>         
       <th>&nbsp;</th>
       <td>
       ...
       <button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Store/norms',array('token' => $token, 'catid' => $catid, 'type' => $type));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
