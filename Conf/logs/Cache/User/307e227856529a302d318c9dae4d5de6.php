...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/cymain.css" />
        <div class="content">
<div class="cLineB">
<h4 class="left">商家列表</h4>
<a href="<?php echo U('Live/index',array('token'=>$token));?>"  class="right btnGrayS vm" >返回</a>
<div class="clr"></div>
</div>

<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Live/company_add',array('token'=>$token,'live_id'=>$live_id));?>" title="添加内容" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加信息</a></div>
...
<th width="120">背景图片</th>
<th width="120">头部图片</th>
<th width="40">显示地图</th>
<th width="40">是否显示</th>
 <th width="40">排序</th>
...
<td><a href="<?php echo ($item["top_pic"]); ?>" target="_blank">点击查看图片</a></td> 
<td>
	<?php if($item["show_map"] == '1'): ?>显示
	<?php else: ?>	
		隐藏<?php endif; ?>
</td> 
<td>
...
<td class="norightborder">
	<a href="<?php echo U('Live/company_add',array('id'=>$item['id'],'token'=>$token,'live_id'=>$live_id));?>">修改</a>
	|
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Live/company_del',array('id'=>$item['id'],'token'=>$token,'live_id'=>$live_id));?>');">删除</a></td>
