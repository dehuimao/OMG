...
<div class="cLineB">
  <h4>公司信息配置 </h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div>
<div class="tab">
<ul>
<li class="tabli" id="tab2"><a href="<?php echo U('Vcard/index');?>">名片列表</a></li>
<li class="current tabli" id="tab20"><a href="<?php echo U('Reply_info/set',array('token'=>$token,'infotype'=>$infoType['type']));?>">公司信息</a></li>
</ul>
</div>
<!--tab end-->        
    <div class="msgWrap bgfc" style="margin-top:10px;">
	  <form class="form" method="post" action="" target="_top" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
				  <th valign="top"><span class="red">*</span>公司名：</th>
				  <td><input type="text" name="company" value="<?php echo ($info["company"]); ?>" class="px" style="width:550px;">
					</td>
				</tr>
				
				<tr>
					<th width="120"><span class="red">*</span>公司简介：</th>
                ...
                <tr>
					<th width="120"><span class="red">*</span>公司电话：</th>
					<td><input type="text" name="company_tel" value="<?php echo ($info["company_tel"]); ?>" class="px" style="width:550px;"></td>
				</tr>
                 <tr>
					<th width="120"><span class="red">*</span>公司传真：</th>
					<td><input type="text" name="fax" value="<?php echo ($info["fax"]); ?>" class="px" style="width:550px;"></td>
				</tr>
                 <tr>
					<th width="120"><span class="red">*</span>公司地址：</th>
					<td><input type="text" name="address" value="<?php echo ($info["address"]); ?>" class="px" style="width:550px;"></td>
				</tr>
            <!--
                 <tr>
					<th width="120"><span class="red">*</span>百度地图：</th>
					<td><input type="text" name="baiduapi" value="<?php echo ($info["baiduapi"]); ?>" class="px" style="width:550px;"></td>
				</tr>
    
				<tr>
					<th>回复图片：</th>
					<td><input type="text" id="picurl" name="picurl" value="<?php echo ($set["picurl"]); ?>" class="px" style="width:550px;">  <input type="button" id="uploadBtn" value="本地上传" /> <br/> 填写图片外链地址，大小为720x400</td>
				</tr>
				<tr>
					<th>第三方接口：</th>
