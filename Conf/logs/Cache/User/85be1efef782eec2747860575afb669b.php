    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      ...
      <tr> 
       ...
       <tr> 
        <th>类别：</th> 
        <td><select name="isbox"><option value="0" <?php if($tableData['isbox'] == 0): ?>selected<?php endif; ?> >大厅</option><option value="1" <?php if($tableData['isbox'] == 1): ?>selected<?php endif; ?>>包间</option></select></td> 
       </tr>
       <tr> 
        <th><span class="red">*</span>容纳人数：</th> 
        <td>
        <input type="text" name="num" id="num" value="<?php echo ($tableData["num"]); ?>" class="px" style="width:100px;" />
        </td> 
       </tr> 
       <tr> 
        <th>预定状态：</th> 
        <td>
        <select name="isorder">
        <option value="0" <?php if($tableData['isorder'] == 0): ?>selected<?php endif; ?> >未预定</option>
        <option value="1" <?php if($tableData['isorder'] == 1): ?>selected<?php endif; ?> >已预定</option>
        </select>
        </td> 
       </tr> 
       <tr> 
        ...
        <td>
        <select name="status">
        <option value="0" <?php if($tableData['status'] == 0): ?>selected<?php endif; ?> >空闲</option>
        <option value="1" <?php if($tableData['status'] == 1): ?>selected<?php endif; ?> >使用中</option>
        </select>
        </td> 
       </tr>
       <tr> 
       ...
       <th>&nbsp;</th>
       <td>
       <button type="submit" name="submit" class="btnGreen" id="save">保存</button> &nbsp; <a href="<?php echo U('Repast/index',array('token' => $token, 'cid' => $cid));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
