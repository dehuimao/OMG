...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/cymain.css" />
        <div class="content">
<div class="cLineB">
<h4>“<?php echo ($thisForm['name']); ?>”表单输入项管理 </h4>
...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Selfform/inputAdd',array('token'=>$token,'formid'=>$thisForm['id']));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<td><?php echo ($item["inputtype"]); ?></td>
<td class="norightborder"><a href="<?php echo U('Selfform/inputSet',array('id'=>$item['id'],'token'=>$token));?>">修改</a>&nbsp;&nbsp;<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Selfform/inputDelete',array('id'=>$item['id'],'token'=>$token));?>');">删除</a></td>
