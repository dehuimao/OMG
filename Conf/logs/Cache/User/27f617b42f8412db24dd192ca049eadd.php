...
<div class="content">
<div class="cLineB">
  <h4>汽车回复配置</h4><!--a href="javascript:history.go(-1);return false;" class="right btnGrayS vm" style="margin-top:-27px">返回</a-->
 </div>
 <!--tab start-->

<!--tab end-->
    <div class="msgWrap bgfc" style="margin-top:10px;">
      <form class="form" method="post" action="" target="_top" enctype="multipart/form-data"><table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"><tbody>
                <tr>
                    <th width="120">触发关键词：</th>
                    <td> <input type="text" name="keyword" id="keyword"  class="px" schoolSet data-rule-maxlength="60" value="<?php echo (($carset['keyword'])?($carset['keyword']):'汽车'); ?>"/>
                ...
                <tr>
                    ...
                    <td>
                         <input type="text" name="title" id="title" value="<?php echo ($carset['title']); ?>" class="px" />
                 ...
                 <tr>
                    ...
                    <td>
                     <p>
                         <img class="thumb_img" id="head_url_src" src="<?php echo (($carset['head_url'])?($carset['head_url']):'tpl/User/default/common/car/car_title.jpg'); ?>"  style="max-height:100px;">
                         <input type="input" class="px" id="head_url" value="<?php echo (($carset['head_url'])?($carset['head_url']):'tpl/User/default/common/car/car_title.jpg'); ?>"  name="head_url" >

                         <span class="help-inline">
                              <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('head_url',365,158,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('head_url')">预览</a>
                ...
                <tr>
                    ...
                    <td>
                      <input type="text" name="url" id="url" value="<?php echo ($carset['url']); ?>" class="px" schoolSet />
                 ...
                 <tr>
                    ...
                    <td>
                         <input type="text" name="title1" id="title1" value="<?php echo (($carset['title1'])?($carset['title1']):'经销车型'); ?>" class="px" />
                ...
                <tr>
                    ...
                    <td>
                     <p>
                         <img class="thumb_img" id="head_url_1_src" src="<?php echo (($carset['head_url_1'])?($carset['head_url_1']):'tpl/User/default/common/car/car_jx.jpg'); ?>" style="max-height:100px;">
                         <input type="input" class="px" id="head_url_1" value="<?php echo (($carset['head_url_1'])?($carset['head_url_1']):'tpl/User/default/common/car/car_jx.jpg'); ?>" name="head_url_1" >

                         <span class="help-inline">
                              <a href="###" onclick="upyunPicUpload('head_url_1',365,158,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('head_url_1')">预览</a>
                 ...
                 <tr>
                    ...
                    <td>
                      <input type="url1" name="url1" id="url1" value="<?php echo ($carset['url1']); ?>" class="px" />
                 ...
                 <tr>
                    ...
                    <td>
                         <input type="text" name="title2" id="title2" value="<?php echo (($carset['title2'])?($carset['title2']):'销售顾问'); ?>" class="px" />
                ...
                <tr>
                    ...
                    <td>
                     <p>
                         <img class="thumb_img" id="head_url_2_src" src="<?php echo (($carset['head_url_2'])?($carset['head_url_2']):'tpl/User/default/common/car/car_yuyue.jpg'); ?>" style="max-height:100px;">
                         <input type="input" class="px" id="head_url_2" value="<?php echo (($carset['head_url_2'])?($carset['head_url_2']):'tpl/User/default/common/car/car_yuyue.jpg'); ?>" name="head_url_2" >

                         <span class="help-inline">
                              <a href="###" onclick="upyunPicUpload('head_url_2',365,158,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('head_url_2')">预览</a>
                              <span class="help-inline">建议图片尺寸365*158，图片大小不超过100K</span>
                         </span>
                     </p>
                    </td>
                 ...
                 <tr>
                    ...
                    <td>
                      <input type="text" name="url2" id="url2" value="<?php echo ($carset['url2']); ?>" class="px" />
                    <span class="help-block">不清楚可以留空</span>
                    </td>
                </tr>
                 ...
                 <tr>
                    ...
                    <td>
                         <input type="text" name="title3" id="title3" value="<?php echo (($carset['title3'])?($carset['title3']):'在线预约'); ?>" class="px" />
                ...
                <tr>
                    ...
                    <td>
                     <p>
                         <img class="thumb_img" id="head_url_3_src" src="<?php echo (($carset['head_url_3'])?($carset['head_url_3']):'tpl/User/default/common/car/car_yuyue.jpg'); ?>" style="max-height:100px;">
                         <input type="input" class="px" id="head_url_3" value="<?php echo (($carset['head_url_3'])?($carset['head_url_3']):'tpl/User/default/common/car/car_yuyue.jpg'); ?>" name="head_url_3" >

                         <span class="help-inline">
                              <a href="###" onclick="upyunPicUpload('head_url_3',365,158,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('head_url_3')">预览</a>
                              <span class="help-inline">建议图片尺寸365*158，图片大小不超过100K</span>
                         </span>
                     </p>
                    </td>
                 ...
                 <tr>
                    ...
                    <td>
                      <input type="text" name="url3" id="url3" value="<?php echo ($carset['url3']); ?>" class="px" />
                    <span class="help-block">不清楚可以留空</span>
                    </td>
                </tr>
                 ...
                 <tr>
                    ...
                    <td>
                         <input type="text" name="title4" id="title4" value="<?php echo (($carset['title4'])?($carset['title4']):'车主关怀'); ?>" class="px" />
                ...
                <tr>
                    ...
                    <td>
                     <p>
                         <img class="thumb_img" id="head_url_4_src" src="<?php echo (($carset['head_url_4'])?($carset['head_url_4']):'tpl/User/default/common/car/carowner.png'); ?>" style="max-height:100px;">
                         <input type="input" class="px" id="head_url_4" value="<?php echo (($carset['head_url_4'])?($carset['head_url_4']):'tpl/User/default/common/car/carowner.png'); ?>" name="head_url_4" >

                         <span class="help-inline">
                              <a href="###" onclick="upyunPicUpload('head_url_4',365,158,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('head_url_4')">预览</a>
                              <span class="help-inline">建议图片尺寸365*158，图片大小不超过100K</span>
                         </span>
                     </p>
                    </td>
                 ...
                 <tr>
                    ...
                    <td>
                      <input type="text" name="url4" id="url4" value="<?php echo ($carset['url4']); ?>" class="px" />
                    <span class="help-block">不清楚可以留空</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                         <input type="text" name="title5" id="title5" value="<?php echo (($carset['title5'])?($carset['title5']):'实用工具'); ?>" class="px" />
                ...
                <tr>
                    ...
                    <td>
                     <p>
                         <img class="thumb_img" id="head_url_5_src" src="<?php echo (($carset['head_url_5'])?($carset['head_url_5']):'tpl/User/default/common/car/tool-box-preferences.png'); ?>" style="max-height:100px;">
                         <input type="input" class="px" id="head_url_5" value="<?php echo (($carset['head_url_5'])?($carset['head_url_5']):'tpl/User/default/common/car/tool-box-preferences.png'); ?>" name="head_url_5" >

                         <span class="help-inline">
                              <a href="###" onclick="upyunPicUpload('head_url_5',365,158,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('head_url_5')">预览</a>
                              <span class="help-inline">建议图片尺寸365*158，图片大小不超过100K</span>
                         </span>
                     </p>
                    </td>
                 ...
                 <tr>
                    ...
                    <td>
                      <input type="text" name="url5" id="url5" value="<?php echo ($carset['url5']); ?>" class="px" />
                    <span class="help-block">不清楚可以留空</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                         <input type="text" name="title6" id="title6" value="<?php echo (($carset['title6'])?($carset['title6']):'车型欣赏'); ?>" class="px" />
                ...
                <tr>
                    ...
                    <td>
                     <p>
                         <img class="thumb_img" id="head_url_6_src" src="<?php echo (($carset['head_url_6'])?($carset['head_url_6']):'tpl/User/default/common/car/lanbo14.jpg'); ?>" style="max-height:100px;">
                         <input type="input" class="px" id="head_url_6" value="<?php echo (($carset['head_url_6'])?($carset['head_url_6']):'tpl/User/default/common/car/lanbo14.jpg'); ?>" name="head_url_6" >

                         <span class="help-inline">
                              <a href="###" onclick="upyunPicUpload('head_url_6',365,158,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('head_url_6')">预览</a>
                              <span class="help-inline">建议图片尺寸365*158，图片大小不超过100K</span>
                         </span>
                     </p>
                    </td>
                 ...
                 <tr>
                    ...
                    <td>
                      <input type="text" name="url6" id="url6" value="<?php echo ($carset['url6']); ?>" class="px" />
                    <span class="help-block">不清楚可以留空</span>
                    </td>
                </tr>
