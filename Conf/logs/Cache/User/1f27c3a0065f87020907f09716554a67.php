            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                ...
                <?php if(is_array($books)): $i = 0; $__LIST__ = $books;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$o): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="norightborder"><a href="###" onclick="showIntroDetail(<?php echo ($o['id']); ?>)" class="btnGreen">详细</a>
                        <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Business/order_del',array('token'=>$o['token'],'id'=>$o['id'],'type'=>$o['type']));?>');"  class="btnGreen">删除</a></td>
