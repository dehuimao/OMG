...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Research/saveInfo', array('token' => $token));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加调研</a></div>
<div class="clr"></div>
</div>
<!--tab end-->
<div class="msgWrap">
