...
<div class="content">
<div class="cLineB">
  <h4>预约系统设置  ---- <?php if($addtype == 'drive'): ?>预约试驾<?php else: ?>预约保养<?php endif; ?> </h4><!--a href="javascript:history.go(-1);return false;" class="right btnGrayS vm" style="margin-top:-27px">返回</a-->
 </div>
...
<!--试驾预约-->
    <?php if($addtype == 'drive'): ?><div class="controls">
      <img class="thumb_img" id="picurl_src" src="<?php echo (($reslist['picurl'])?($reslist['picurl']):'tpl/User/default/common/car/yuyue.jpg'); ?>" style="max-height:100px;">
      <input id="picurl" type="text" class="span4" name="picurl" class="input-xlarge"  schoolSet data-rule-url="true" value="<?php echo (($reslist['picurl'])?($reslist['picurl']):'tpl/User/default/common/car/yuyue.jpg'); ?>" />
...
<?php else: ?>
 <div class="controls">
      <img class="thumb_img" id="picurl_src" src="<?php echo (($reslist['picurl'])?($reslist['picurl']):'tpl/User/default/common/car/baoyang.jpg'); ?>" style="max-height:100px;">
      <input id="picurl" type="text" class="span4" name="picurl" class="input-xlarge"  schoolSet data-rule-url="true" value="<?php echo (($reslist['picurl'])?($reslist['picurl']):'tpl/User/default/common/car/baoyang.jpg'); ?>" />
          <span class="help-inline">
               <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('picurl',720,400,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('picurl')">预览</a>
              <span class="help-inline">建议尺寸：宽720像素，高400像素</span>
          </span>
...
<div class="control-group">
         ...
         <div class="controls">
             <input type="text" name="tel" id="tel" class="span4" value="<?php echo ($reslist['tel']); ?>"  schoolSet  placeholder="请输入接收预约的电话号码"/><span class="maroon">*</span><span class="help-inline">如0551-62696666</span>
         </div>
     </div>
     <div class="control-group">
...
<!--试驾预约-->
    <?php if($addtype == 'drive'): ?><div class="controls">
             <img class="thumb_img" id="headpic_src" src="<?php echo (($reslist['headpic'])?($reslist['headpic']):'tpl/User/default/common/car/yuyue.jpg'); ?>" style="max-height: 100px;">
              <input id="headpic"type="text"class="input-large" name="headpic" class="span4 px"  schoolSet data-rule-url="true" value="<?php echo (($reslist['headpic'])?($reslist['headpic']):'tpl/User/default/common/car/yuyue.jpg'); ?>" />
...
<?php else: ?>
 <div class="controls">
             <img class="thumb_img" id="headpic_src" src="<?php echo (($reslist['headpic'])?($reslist['headpic']):'tpl/User/default/common/car/baoyang.jpg'); ?>" style="max-height: 100px;">
              <input id="headpic"type="text"class="input-large" name="headpic" class="span4 px"  schoolSet data-rule-url="true" value="<?php echo (($reslist['headpic'])?($reslist['headpic']):'tpl/User/default/common/car/baoyang.jpg'); ?>" />
            <span class="maroon">*</span>
            <span class="help-inline">
            <a href="###" onclick="upyunPicUpload('headpic',720,400,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('headpic')">预览</a>
         </div><?php endif; ?>
