...
<div class="cLineB">
  <h4>微邀请配置</h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div>
		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				...
				<tr>
					...
					<td><input type="text" name="keyword" value="<?php echo ($info["keyword"]); ?>" class="px" style="width:550px;"><br/> <span class="red">只能写一个关键词</span>，用户输入此关键词将会触发此活动。
</td>
				</tr>
				<tr>
					<th>回复图片：</th>
					<td><input type="text" name="picurl" id="picurl" value="<?php echo ($info["picurl"]); ?>" class="px" style="width:550px;">   <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('picurl',720,400,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('picurl')" class="ChooseImage">预览</a>&nbsp;填写图片外链地址，大小为720x400</td>
				</tr>
 <tr>
					<th>邀请类型：</th>
					<td>
                    <select name="type">
					<option value="1" <?php if($info["type"] == 1): ?>selected<?php endif; ?>>会议</option>
					<option value="2" <?php if($info["type"] == 2): ?>selected<?php endif; ?>>聚会</option>
					<option value="3" <?php if($info["type"] == 3): ?>selected<?php endif; ?>>活动</option>
					</select>
                    </td>
				</tr>
<tr>
					...
					<td>
                    	<textarea style="width:560px;height:75px" name="brief" id="brief" class="px"><?php echo ($info["brief"]); ?></textarea>
</td>
				</tr>
<tr>
					<th width="120"><span class="red">*</span>内容：</th>
					<td>
                    	<textarea style="width:560px;height:75px" name="content" id="content" class="px"><?php echo ($info["content"]); ?></textarea>
</td>
				</tr>
<tr>
			  <th><span class="red">*</span>日期：</th>
			  <td><input type="text" name="statdate" id="statdate" class="px" value="<?php echo ($info["statdate"]); ?>" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss' })"></td>
			</tr>
				<tr>
					<th><span class="red">*</span>地址：</th>
					<td><input type="text" name="address" value="<?php echo ($info["address"]); ?>" class="px" style="width:550px;"></td>
				</tr>
				<tr>
					<th><span class="red">*</span>经纬地址：</th>
					<td>经度 <input type="text" id="longitude"  name="lng" size="14" class="px" value="<?php echo ($info["lng"]); ?>" /> 纬度 <input type="text"  name="lat" size="14" id="latitude" class="px" value="<?php echo ($info["lat"]); ?>" /> <a href="###" onclick="setlatlng($('#longitude').val(),$('#latitude').val())">在地图中查看/设置</a></td>
				</tr>

				<tr>
					<th><span class="red"></span>底部版权：</th>
					<td><input type="text" name="copyrite" value="<?php echo ($info["copyrite"]); ?>" class="px" style="width:400px;">  <span>例如：© 2001-2015 <?php echo ($f_siteTitle); ?>版权所有</span></td>
				</tr>
