...
<ul id="tags" style="width:100%">
		...
		<li <?php if($tab == 'config'): ?>class="selectTag"<?php endif; ?>>
          ...
          <div class="ftip" style="margin:25px auto 5px auto;">共有<?php echo ($pageinfo["total"]); ?>人在线</div>
...
<th style=" width:100px;">下行</th>  
<th style=" width:100px;">上行</th>             
<th style=" width:150px;" class="norightborder">连接时间</th>
</tr>
</thead>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$actinfo): $mod = ($i % 2 );++$i;?><tr>
<td><?php echo ($actinfo["mac"]); ?></td>
<td><?php echo ($actinfo["ip"]); ?></td>
    <td><?php echo ($actinfo['in_come']/1024).'kb';?></td>
    <td><?php echo ($actinfo['out_go']/1024).'kb';?></td>
<td class="norightborder">
<?php date('Y-m-d H:i:s',$actinfo['created_at']);?>
