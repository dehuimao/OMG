...
<tr>
    ...
    <td width="50">排序</td>
     <td width="50">票数</td>
    <?php if($vo['type'] == 'img' OR $type == 'img' OR ($vo['type'] == 'scene') OR ($type == 'scene')): ?><td width="260">图片外链地址</td>
...
<a href="###" onclick="upyunPicUpload('startpicurl_<?php echo ($i+50); ?>',700,400,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('startpicurl_<?php echo ($i+50); ?>')">预览</a>
</td>
    ...
    <tr >
     <input type="hidden" name="add[id][]" readonly="readonly" disabled="disabled"  value="" style="width:20px;" >
        ...
        <?php if($vo['type'] == 'img' OR $type == 'img' OR ($vo['type'] == 'scene') OR ($type == 'scene')): ?><td width="200">
          ...
          <a href="###" onclick="upyunPicUpload('startpicurl_1',700,400,'<?php echo ($token); ?>')" class="a_upload">上传</a>
    ...
    <tr >
     <input type="hidden" name="add[id][]" readonly="readonly" disabled="disabled"  value="" style="width:20px;" >
        ...
        <?php if($vo['type'] == 'img' OR $type == 'img' OR ($vo['type'] == 'scene') OR ($type == 'scene')): ?><td width="200">
          ...
          <a href="###" onclick="upyunPicUpload('startpicurl_2',700,400,'<?php echo ($token); ?>')" class="a_upload">上传</a>
    ...
    <tr >
      <input type="hidden" name="add[id][]" readonly="readonly" disabled="disabled"  value="" style="width:50px;" >
        ...
        <?php if($vo['type'] == 'img' OR $type == 'img'): ?><td width="200">
          ...
          <a href="###" onclick="upyunPicUpload('startpicurl_3',700,400,'<?php echo ($token); ?>')" class="a_upload">上传</a>
    ...
    <tr >
      <input type="hidden" name="add[id][]" readonly="readonly" disabled="disabled"  value="" style="width:50px;" >
        ...
        <?php if(($vo['type'] == 'img') OR ($type == 'img')): ?><td width="200">
          ...
          <a href="###" onclick="upyunPicUpload('startpicurl_4',700,400,'<?php echo ($token); ?>')" class="a_upload">上传</a>
    ...
    <tr >
     <input type="hidden" name="add[id][]" readonly="readonly" disabled="disabled"  value="" style="width:50px;" >
        ...
        <?php if(($vo['type'] == 'img') OR ($type == 'img')): ?><td width="200">
          ...
          <a href="###" onclick="upyunPicUpload('startpicurl_5',700,400,'<?php echo ($token); ?>')" class="a_upload">上传</a>
    ...
    <tr >
     <input type="hidden" name="add[id][]" readonly="readonly" disabled="disabled"  value="" style="width:50px;" >
        ...
        <?php if(($vo['type'] == 'img') OR ($type == 'img')): ?><td width="200">
          ...
          <a href="###" onclick="upyunPicUpload('startpicurl_6',700,400,'<?php echo ($token); ?>')" class="a_upload">上传</a>
    ...
    <tr >
     <input type="hidden" name="add[id][]" readonly="readonly" disabled="disabled"  value="" style="width:50px;" >
        ...
        <?php if(($vo['type'] == 'img') OR ($type == 'img')): ?><td width="200">
          ...
          <a href="###" onclick="upyunPicUpload('startpicurl_7',700,400,'<?php echo ($token); ?>')" class="a_upload">上传</a>
    ...
    <tr >
     <input type="hidden" name="add[id][]" readonly="readonly" disabled="disabled"  value="" style="width:50px;" >
        ...
        <?php if(($vo['type'] == 'img') OR ($type == 'img')): ?><td width="200">
          ...
          <a href="###" onclick="upyunPicUpload('startpicurl_8',700,400,'<?php echo ($token); ?>')" class="a_upload">上传</a>
    ...
    <tr >
     <input type="hidden" name="add[id][]" readonly="readonly" disabled="disabled"  value="" style="width:50px;" >
        ...
        <?php if(($vo['type'] == 'img') OR ($type == 'img')): ?><td width="200">
          ...
          <a href="###" onclick="upyunPicUpload('startpicurl_9',700,400,'<?php echo ($token); ?>')" class="a_upload">上传</a>
    ...
    <tr >
     <input type="hidden" name="add[id][]" readonly="readonly" disabled="disabled"  value="" style="width:50px;" >
        ...
        <?php if(($vo['type'] == 'img') OR ($type == 'img')): ?><td width="200">
          ...
          <a href="###" onclick="upyunPicUpload('startpicurl_10',700,400,'<?php echo ($token); ?>')" class="a_upload">上传</a>
