...
<div class="content">
          ...
          <div class="cLine">
            <div class="pageNavigator left">
                <a href="<?php echo U('Car/carbrand',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
           ...
           <input name="wxid" type="hidden" value="gh_423dwjkewad">
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <?php if(is_array($brands)): $i = 0; $__LIST__ = $brands;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <a class="btn" onclick="return(confirm('确定要删除吗？'))" href="<?php echo U('Car/brand_del',array('token'=>$vo['token'],'bid'=>$vo['id']));?>" title="删除"  >删除</a></td>
