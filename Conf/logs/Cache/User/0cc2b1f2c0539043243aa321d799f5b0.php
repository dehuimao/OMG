...
<div class="cLineB">
  ...
  <h4>照片墙上传照片管理 <span class="FAQ"></span></h4>
  
 </div>

           <div class="cLine">
            <div class="pageNavigator left">
  <a href='<?php echo U('Zhaopianwall/index',array('token'=>$token));?>' title='返回照片墙管理' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/img/activity-scratch-card.png" class="vm" />返回照片墙管理</a>
...
<TD>
				  <?php if($vo['state'] == 0): ?>待审核<?php elseif($vo['state'] == 1): ?>审核通过<?php else: ?>审核通过<?php endif; ?>
				  
				 </TD>
<td class="norightborder">
	<a href="<?php echo U('Zhaopianwall/delpic',array('id'=>$vo['id']));?>">删除</a>
	<a href="<?php echo U('Zhaopianwall/agreepic',array('id'=>$vo['id']));?>">同意</a>
</td>
