...
<div class="content" >  
<div class="cLineB">
  <h4><?php echo ($info["name"]); ?>中奖名单</h4><a href="javascript:history.go(-1);"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a>
 </div>
...
<th style=" width:150px;" class="norightborder">奖项</th>
</tr>
</thead>
<?php if(is_array($records)): $i = 0; $__LIST__ = $records;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$actinfo): $mod = ($i % 2 );++$i;?><tr>
<td><?php echo ($actinfo["nickname"]); ?></td>
<td><?php echo ($actinfo["mp"]); ?></td>
<td><?php echo ($actinfo["prize"]); ?></td><?php endforeach; endif; else: echo "" ;endif; ?>
</tr>
