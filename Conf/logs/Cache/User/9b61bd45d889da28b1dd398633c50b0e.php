...
<script src="/tpl/static/artDialog/plugins/iframeTools.js"></script>
     <div class="content">
<div class="cLineB">
<h4 class="left">订单类型信息 (<?php echo ($page); ?>) </h4>
<div class="searchbar right">
<a href="<?php echo U('Host/index',array('token'=>$token));?>" class="btnGreen vm">返回</a>
</div>
<div class="clr"></div>
</div>
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Host/list_add',array('token'=>$token,'hid'=>$_GET['id']));?>" title="新增订单类型" class="btnGrayS vm bigbtn">新增订单类型 </a> </div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<tbody>
<tr></tr>
<?php if(is_array($li)): $i = 0; $__LIST__ = $li;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
<td><input type="checkbox" name="del_id[]" value="285" class="checkitem"></td>
<td><?php echo ($list["type"]); ?></td>
<td><?php echo ($list["price"]); ?></td>
<td><?php echo ($list["yhprice"]); ?></td>
<td><?php echo ($list["info"]); ?></td>
 
<td colspan="10" class="norightborder">  <a  href="<?php echo U('Host/list_edit',array('id'=>$list['id'],'token'=>$token));?>">编辑</a> |
<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Host/list_del',array('id'=>$list['id'],'token'=>$token));?>');">删除</a>
