...
<input type="submit" value="搜索" id="msgSearchBtn" href="" class="btnGrayS" title="搜索">
          ...
          <div class="cLine">
            ...
            <a href="<?php echo U('Paper/add',array('token'=>$token));?>" title="添加秘密小纸条" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加秘密小纸条</a>
            </div>
            <div class="clr"></div>
          </div>
          <div class="msgWrap">
...
<TH style=" width:200px;" class="norightborder">操作</TH>
              ...
              <TBODY>
                <TR></TR>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?></TD>
                  <TD><?php echo ($i); ?></TD>
                  <TD><?php echo ($item["title"]); ?></TD>
                  <TD><?php echo ($item["keyword"]); ?></TD>
                  <TD class="norightborder">
				  <a href="<?php echo U('Paper/set',array('id'=>$item['id'],'token'=>$token));?>"class="button icon edit">修改</a>
				  <a href="javascript:drop_confirm('您确定要删除吗?','<?php echo U('Paper/del',array('id'=>$vo['id']));?>');"class="button danger icon remove">删除</a>
				   </TD>
