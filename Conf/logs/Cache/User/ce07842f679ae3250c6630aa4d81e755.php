		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				...
				<tr>
					<th>背景音乐：</th>
					<td>
					<table><tr><?php if($home["musicurl"] != ''): ?><td><a style="width:120px;float:left" id="musicurl_src" class="audio {skin:'blue'}" href="<?php echo ($home["musicurl"]); ?>">音乐播放</a></td><?php endif; ?><td> <input type="text" class="px" name="musicurl" value="<?php echo ($home["musicurl"]); ?>" id="musicurl" style="width:200px;float:left" onchange="$('#musicurl_src').attr('href',this.value"> <a href="###" onclick="upyunPicUpload('musicurl',0,0,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;<a href="###" onclick="chooseFile('musicurl','music')" class="a_upload">选择</a></td></tr></table>
					 </td>
				</tr>
				<tr>
					<th>公司Logo：</th>
