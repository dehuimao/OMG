...
<div class="cLineB">
  <h4>汽车文章类型管理</h4> 最新车讯，最新优惠，尊享二手车都读取于 <a href="<?php echo U('Classify/index',array('token'=>$token));?>" class="btn"> <strong><font color='red'>分类管理</strong></font></a>,如果没有，请先到<a href="<?php echo U('Classify/add',array('token'=>$token));?>" class="btn"> <strong><font color='red'>分类管理</strong></font></a>添加</span>,然后再［<a href="<?php echo U('Img/add',array('token'=>$token));?>"><strong><font color='red'>图文回复</strong></font></a>］添加您想添加的内容 <span class="help-inline"> <span class="maroon">的［<a href="<?php echo U('Img/index',array('token'=>$token));?>"><strong><font color='red'>新增图文自定义回复</strong></font></a>］！</span> <!--a href="javascript:history.go(-1);return false;" class="right btnGrayS vm" style="margin-top:-27px">返回</a-->
 </div>
 <!--tab start-->
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <span class="maroon">如选择：兰博基尼欣赏</span>
                     ，如果没有请去：<a href="<?php echo U('Photo/add',array('token'=>$token,'poid'=>$carnews['album_id']));?>" class="btn">添加相册</a></td>
                    </td>
                </tr>
                <tr>
                    <th>店铺LBS：</th>
                    ...
                    <span class="maroon"></span>
                     ，如果没有请去：<a href="<?php echo U('Company/index',array('token'=>$token,'poid'=>$carnews['company_id']));?>" class="btn">添加LBS</a></td>
                    </td>
                </tr>
                <tr>
                    <td>
