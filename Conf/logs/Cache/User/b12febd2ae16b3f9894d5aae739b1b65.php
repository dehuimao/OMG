     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <tr> 
        ...
        <td>
        <input type="text" name="price" id="price" value="<?php echo ($tableData["price"]); ?>" class="px" style="width:100px;" />
        </td> 
       </tr> 
       <tr> 
        <th><span class="red">*</span>会员价格：</th> 
        <td>
        <input type="text" name="vprice" id="vprice" value="<?php echo ($tableData["vprice"]); ?>" class="px" style="width:100px;" />
        </td> 
       </tr> 
       <tr> 
