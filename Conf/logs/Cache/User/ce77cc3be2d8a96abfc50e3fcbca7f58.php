...
<?php if($type == 1): ?><div class="pageNavigator left">
	<a href="<?php echo U('Store/normsAdd',array('token' => $token, 'catid' => $catid, 'type' => $type));?>" title="新增外观值" class="btnGrayS vm bigbtn">
	<img src="<?php echo RES;?>/images/product/add.png" class="vm">新增<span class="red"><?php echo ($catData["name"]); ?></span>分类的外观值</a>
</div>
<?php else: ?>
<div class="pageNavigator left">
	<a href="<?php echo U('Store/normsAdd',array('token' => $token, 'catid' => $catid, 'type' => $type));?>" title="新增规格值" class="btnGrayS vm bigbtn">
