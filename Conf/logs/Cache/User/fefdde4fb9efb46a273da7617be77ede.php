...
<div class="content">
          <div class="cLineB">
              <h4 class="left">当前位置：微学校 >> 食谱管理</h4><a href="<?php echo U('School/cookbook_add',array('token'=>$token,'type'=>'assess'));?>" class="right btnGreen vm" style="margin-top:-2px">新增食谱</a>
              <div class="clr"></div>
          </div>

<!-- <div class="cLineC" style="line-height: 32px;"> <a href="<?php echo U('School/cookbook_add',array('token'=>$token,'type'=>'school'));?>" class="btnGrayS vm bigbtn">添加食谱</a>　 </div> -->
        ...
        <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
          <thead>
            <tr>
              ...
              <th style=" width:100px;">开始/结束时间</th>
             <!--  <th style=" width:100px;">图文消息封面</th> -->
              <th style=" width:100px;">是否显示</th>
              <th style=" width:120px;">操作</th>
            </tr>
          </thead>
<?php if(is_array($recipe)): $i = 0; $__LIST__ = $recipe;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody><tr>
              <td><?php echo ($vo['title']); ?></td>
              <td><?php echo ($vo['keyword']); ?></td>
              <td><?php echo (date("Y-m-d",$vo['begintime'])); ?> / <?php echo (date("Y-m-d",$vo['endtime'])); ?></td>
              <td><?php if($vo['ishow'] == 1): ?>显示<?php else: ?>隐藏<?php endif; ?></td>
              <td class="norightborder">
              <a href="<?php echo U('School/cookbook_add',array('id'=>$vo['id'],'type'=>$vo['type']));?>" class="btnGreen">编辑</a>
              <a href="<?php echo U('School/cookbook_del',array('id'=>$vo['id'],'type'=>$vo['type']));?>" onclick="return(confirm('确定要删除吗？'))" class="btnGreen">删除</a> </td>
