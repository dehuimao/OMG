...
<div class="content"> 
	<div class="cLineB"> 
		<h4>房间分类操作</h4> 
		<a href="<?php echo U('Hotels/index',array('token' => $token,'cid'=>$cid));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
	</div> 
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <tr> 
        ...
        <td>
        <select name="sid">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option value="<?php echo ($row['id']); ?>"><?php echo ($row['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        </td> 
       </tr> 
       <tr> 
       ...
       <tr> 
        <th>描述：</th> 
        <td><textarea name="note" class="px" style="width:400px;height:80px;"><?php echo ($tableData["note"]); ?></textarea></td> 
       </tr>
       <tr>   
       <th>&nbsp;</th>
       <td>
       <button type="submit" name="submit" class="btnGreen" id="save">保存</button> &nbsp; <a href="<?php echo U('Hotels/index',array('token' => $token, 'cid' => $cid));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
