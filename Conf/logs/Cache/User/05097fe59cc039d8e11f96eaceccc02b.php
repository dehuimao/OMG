...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/cymain.css" />
        <div class="content">
<div class="cLineB">
<h4>“<?php echo ($thisForm["name"]); ?>”信息列表 <?php if($page): ?>(<?php echo ($page); ?>)<?php endif; ?> &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo U('Selfform/index',array('token'=>$token));?>">返回</a> </h4>
...
<th width="40">ID</th>
<th width="120">时间</th>
<?php if(is_array($fields)): $i = 0; $__LIST__ = $fields;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><th><?php echo ($item["displayname"]); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
<th width="30" class="norightborder">操作</th>
</tr>
</thead>
<tbody>
<tr></tr>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
<?php if(is_array($item)): $i = 0; $__LIST__ = $item;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$citem): $mod = ($i % 2 );++$i;?><td><?php echo ($citem); ?></td><?php endforeach; endif; else: echo "" ;endif; ?>
<td class="norightborder"><a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Selfform/infoDelete',array('id'=>$item['id'],'token'=>$token));?>');">删除</a></td>
