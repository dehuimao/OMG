...
$(document).ready(function(){
  ...
  <a href='<?php echo U('LuckyFruit/add',array('token'=>$token));?>' title='新增<?php echo ($lotteryTypeName); ?>活动' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/img/activity-scratch-card.png" class="vm" />新增<?php echo ($lotteryTypeName); ?>活动</a>
              ...
              <TBODY>
                <TR></TR>
				  ...
				  <?php if($list['status'] == 0): ?><span class="red">未开始</span><?php else: ?><span class="green">已经开始</span><?php endif; ?>
				   ...
				   <a href="index.php?g=User&m=Lottery&a=sn&id=<?php echo ($list["id"]); ?>&type=4">SN码管理</a> 
