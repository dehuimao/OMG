...
$(document).ready(function(){
  ...
  <a href='<?php echo U('AppleGame/add',array('token'=>$token));?>' title='新增<?php echo ($lotteryTypeName); ?>活动' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/img/activity-scratch-card.png" class="vm" />新增<?php echo ($lotteryTypeName); ?>活动</a>
...
<TH class="norightborder">操作</TH>
              ...
              <TBODY>
                <TR></TR>
				  ...
				  <a href="index.php?g=User&m=AppleGame&a=detail&id=<?php echo ($list["id"]); ?>">详情</a>
				   <a href="index.php?g=User&m=AppleGame&a=edit&id=<?php echo ($list["id"]); ?>">编辑</a>  
				  
	
				   <a href="
				   <?php if($list['status'] == 1): ?>javascript:drop_confirm('你确定要结束活动吗，结束后不可再开启本活动!', 'index.php?g=User&m=AppleGame&a=endLottery&id=<?php echo ($list["id"]); ?>');<?php else: ?>index.php?g=User&m=AppleGame&a=startLottery&id=<?php echo ($list["id"]); endif; ?>">
				   <?php if($list['status'] == 0): ?>开始<?php else: ?>结束<?php endif; ?>				   
				   </a>
				  
				   <a href="index.php?g=User&m=AppleGame&a=del&id=<?php echo ($list["id"]); ?>">删除</a></TD>
