            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                ...
                <?php if(is_array($books)): $i = 0; $__LIST__ = $books;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$o): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="norightborder"><a href="###" onclick="showIntroDetail(<?php echo ($o["iid"]); ?>)">详细</a>  <a class="btn" href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Medical/manage_del',array('token'=>$o['token'],'iid'=>$o['iid']));?>');"  title="删除">删除</a></td>
