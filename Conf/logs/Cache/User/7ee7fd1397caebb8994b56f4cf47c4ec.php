...
function regexChange(){
  ...
  <div class="content"> 
   <div class="cLineB"> 
    <h4>“<?php echo ($thisForm['name']); ?>”输入项设置</h4> 
    <a href="<?php echo U('Selfform/inputs',array('token'=>$token,'id'=>$thisForm['id']));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
   

   <form class="form" method="post" id="form" action=""> 
<?php if($isUpdate == 1): ?><input type="hidden" name="id" value="<?php echo ($set["id"]); ?>" /><?php endif; ?>
<input type="hidden" name="formid" value="<?php echo ($thisForm['id']); ?>" />
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       <tr> 
        <th><span class="red">*</span>显示名称：</th>
        <td><input type="text" id="displayname" name="displayname" value="<?php echo ($set["displayname"]); ?>" class="px require" style="width:400px;" /></td> 
       </tr> 
        <tr> 
        <th><span class="red">*</span>字段名称：</th>
        <td><input type="text" id="fieldname" name="fieldname" value="<?php echo ($set["fieldname"]); ?>" class="px require" style="width:400px;" /> <span style="color:red">注意字段名称不能是a</span></td> 
       </tr> 
       <tr> 
        <th><span class="red">*</span>输入类型：</th>
        <td><select name="inputtype" id="inputtype" onchange="inputtypeChange()"><?php echo ($inputTypeOptions); ?></select></td> 
       </tr>
       <tr id="troptions"<?php if($set['inputtype'] != select): ?>style="display:none"<?php endif; ?>> 
        <th><span class="red"></span>选项：</th>
        <td><input type="text" id="options" name="options" value="<?php echo ($set["options"]); ?>" class="px require" style="width:400px;" /> 下拉列表的各个选项，多个选项用“|”隔开</td> 
       </tr>
       <tr> 
        <th><span class="red">*</span>是否必填：</th>
        <td><select name="require" id="require"><?php echo ($requireOptions); ?></select></td> 
       </tr> 
       <tr> 
        <th><span class="red">*</span>输入限制：</th>
        <td><select name="regexSelect" id="regexSelect" onchange="regexChange()"><?php echo ($regexOptions); ?></select> <input type="text" name="regex" id="regex" value="<?php echo ($set["regex"]); ?>" class="px" style="width:400px;" /> 可以自己编写正则表达式</td> 
       </tr>
       </tr>
        <tr> 
        <th><span class="red">*</span>排序：</th>
        <td><input type="text" name="taxis" id="taxis" value="<?php echo ($set["taxis"]); ?>" class="px" style="width:400px;" /></td> 
       </tr>
       <tr> 
        <th><span class="red"></span>错误提示：</th> 
        <td><input type="text" name="errortip" id="errortip" value="<?php echo ($set["errortip"]); ?>" class="px" style="width:400px;" /> 输入错误时的提示内容</td> 
       </tr>

       <th>&nbsp;</th>
       <td>
       <button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Selfform/inputs',array('token'=>$token,'id'=>$thisForm['id']));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
