...
<ul>
<form action="<?php if (C('pay_type') == 'tenpay') { echo U('Tenpay/recharge'); } else if (C('pay_type') == 'kuaiqian') { echo U('Alipay/kuaiqian'); } else { echo U('Alipay/recharge'); }?>" method="post" onsubmit="return checkcz()">
