...
<tr>
  ...
  <TD>
  <input type="input" class="px" id="music" value="<?php if($info["music"] == ''): echo ($f_siteUrl); ?>/tpl/static/live/default/mis.mp3<?php else: echo ($info["music"]); endif; ?>" name="music" style="width:250px" value="" >  
  <script src="/tpl/static/upyun.js"></script>
  <a href="###" onclick="upyunPicUpload('music',640,990,'<?php echo ($token); ?>')" class="a_upload">上传</a> 
  <a href="###" onclick="chooseFile('music','music')" class="a_upload">选择</a> 
    &nbsp;&nbsp;
    （设置微场景的背景音乐）
...
<tr id="masking_pic">
  ...
  <td>
    <input class="px"  name="masking_pic" value="<?php if($info['masking_pic'] == ''): echo ($f_siteUrl); ?>/tpl/static/attachment/background/car/4.jpg<?php else: echo ($info["masking_pic"]); endif; ?>" id="pic2" style="width:250px;"  />
      ...
      <a href="###" onclick="viewImg('pic2')">预览</a>[640*990]&nbsp;（开启幕布后生效，首页需要拉开幕布才能进入场景）
    </td>
</tr>
