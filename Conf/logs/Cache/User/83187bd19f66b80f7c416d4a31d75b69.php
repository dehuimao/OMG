...
<ul id="tags" style="width:100%">
		...
		<li <?php if($tab == 'config'): ?>class="selectTag"<?php endif; ?>>
          ...
          <div class="ftip" style="margin:25px auto 5px auto;">下面是您拥有的路由器列表</div>
          <div class="cLineC" style="line-height: 32px;">
 <a href="<?php echo U('Router/set');?>" class="btnGrayS vm bigbtn" >添加路由</a>　 
</div>
         <div class="msgWrap form">
...
<thead>
<tr>
<th style=" width:180px;">路由器ID</th>
<th style=" width:100px;">路由器名称</th>
<th style=" width:100px;">绑定的公众号</th>              
...
<td><?php echo ($actinfo["gw_id"]); ?></td>
<td><?php echo ($actinfo["name"]); ?></td>
    <td><?php echo ($actinfo["wechat"]); ?></td>
<td class="norightborder">
<a href="<?php echo U('Router/lists',array('id'=>$actinfo['id'],'token'=>$_SESSION['token']));?>" >在线列表</a>&nbsp;<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Router/delete',array('token'=>$token,'id'=>$actinfo['id']));?>');">删除</a>
