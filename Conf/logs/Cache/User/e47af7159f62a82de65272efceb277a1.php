		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			...
			<tbody>
                ...
                <TR>
                  ...
                  <TD><input type="text" class="px" id="url" value="<?php echo ($set["url"]); ?>" name="url" style="width:280px;"><a href="###" onclick="addLink('url',0)" class="a_choose">从功能库添加</a></if><br /><span class="red">如需点击"更多内容跳"转到其他网址，请在输入框右侧选择或这里填写网址(例如：<?php echo ($f_siteUrl); ?>，记住如果填写必须有http://)</span>如果填写了图文详细内容，这里请留空，不要设置！</TD>
                </TR>
                 <TR>
                  <TH valign="top"><span class="red">*</span>分享后跳转地址：</TH>
                  <TD><input type="text" class="px" id="shareurl" value="<?php echo ($set["shareurl"]); ?>" name="shareurl" style="width:280px;"><a href="###" onclick="addLink('url',0)" class="a_choose">从功能库添加</a></if><br /><span class="red">如需分享后跳转到其他网址，请在输入框右侧选择或这里填写网址(例如：<?php echo ($f_siteUrl); ?>，记住如果填写必须有http://)</span>如果填写了图文详细内容，这里请留空，不要设置！</TD>
                </TR>
