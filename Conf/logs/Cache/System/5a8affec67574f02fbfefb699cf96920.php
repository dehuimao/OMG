...
<form action="" method="post" name="form" enctype="multipart/form-data" id="myform">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
				 ...
				 <tr>
					<th colspan="4">设置代理商优惠套餐</th>
				</tr>
				<tr>
					<td height="48" align="right"><strong>套餐名称：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="name" class="ipt" size="45" value="<?php echo ($info["name"]); ?>" />
					</td>
				</tr>
				<tr>
					<td height="48" align="right"><strong>公众号账户数：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="maxaccount" class="ipt" size="45" value="<?php echo ($info["maxaccount"]); ?>" /> 个（这个套餐可以开多少个公众号）
					</td>
				</tr>
				<tr>
					<td height="48" align="right"><strong>套餐价格：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="price" class="ipt" size="45" value="<?php echo ($info["price"]); ?>" />  元
					</td>
				</tr>
