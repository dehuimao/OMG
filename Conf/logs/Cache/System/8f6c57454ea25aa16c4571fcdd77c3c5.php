...
<title><?php echo ($f_siteName); ?>-微企后台管理系统</title>
  ...
  <tr>
	...
	<div class="top">
    	<a href="/" class="logo" title="首页">首页</a>
		 <div class="login">
			<li>您好：<b><?php echo (session('username')); ?></b> ，欢迎使用微企！</li>	
			<li><a href="/index.php" target="_blank"> 访问首页</a></li>
			<li><a href="/index.php?g=User&m=Index&a=index" target="_blank">用户中心</a></li>
			<li><a href="http://www.weiqimobile.com">官方网址</a></li>
			<li><a href="http://weixin-app.taobao.com">淘宝官方店</a></li>
...
<p class="fr"> Copyright &copy; 2013-2016 微企版权所有  </p>
</div></td>
  </tr>
</table>
</body>
