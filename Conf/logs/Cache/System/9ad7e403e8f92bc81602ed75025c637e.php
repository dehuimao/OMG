...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 ...
 <tr> 
      ...
      <td><select name="pay_type" id="pay_type"><option value="alipay"<?php if (C('pay_type')==''||C('pay_type')=='alipay'){echo ' selected';}?>>支付宝</option><option value="tenpay"<?php if (C('pay_type')=='tenpay'){echo ' selected';}?>>财付通</option></select>
	  </td>
    </tr>
 <tr> 
    ...
    <tr> 
      ...
      <td><input type="text" name="alipay_name" value="<?php echo C('alipay_name');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：kf@weiqimobile.com(仅选择支付宝时填写)</span>
	  </td>
    </tr>
	 <tr> 
