...
<meta name="description" content="<?php echo ($f_metaKeyword); ?>"/>
...
处处体现着产品的用心。赞！</p>
<div class="people"><img src="<?php echo RES;?>/images/ren2.jpg" class="f_l"><span><span class="hisname">施郁华</span><span class="profiler">深圳聆诗设计设计总监</span></span></div>
</div><!--end conbox-->
<div class="conbox">
...
<div class="people"><img src="<?php echo RES;?>/images/ren3.jpg" class="f_l"><span><span class="hisname">刘佳</span><span class="profiler">曼妮莎女装运营经理</span></span></div>
</div><!--end conbox-->
</div><!--end conmentcon-->
</div><!--end conmenter-->
