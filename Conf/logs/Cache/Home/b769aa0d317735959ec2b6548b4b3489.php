...
<title>功能介绍－<?php echo ($f_siteTitle); ?></title>
...
<div class="qtcontent">
        <div class="intro">
            <div class="normalTitle"><h2><?php echo ($f_siteName); ?>功能简介</h2></div>
...
<div style="display: none;">
                                <span class="marginb">
                                <h3>20.自定义图文回复</h3>
                                <p>在<?php echo ($f_siteName); ?>微信后台设置关键词，编辑对应的回复内容，以图文形式显示。</p>
<p>还有关联的图文展示，推荐阅读。</p>
                                <p>效果更好，用户体验更佳。</p>
                                </span>
...
<p>例如：朗读你好，<?php echo ($f_siteName); ?>欢迎你！</p>
                                </span>
...
<p><?php echo ($f_siteName); ?>还有专门的淘宝客功能，适合做手机淘宝客的人使用，粉丝购买后可以得到佣金，手机支付以后是个趋势，抓住先机，以后佣金倍增。</p>
                                </span>
...
<p>范例：给<?php echo ($f_siteName); ?>微信号输入“投票”或者“图片投票”体验一下投票活动。</p>
                                </span>
