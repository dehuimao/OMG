...
.case-nav li{ height:26px;color:#FFF; line-height:26px; text-align:center; cursor:pointer;position:relative; list-style:none}
	...
	<div class="Public">
		...
		<div class="Public-box clearfix">
			<ul id="nav_lis" class="case-nav left">
				<li data-index="0" data-hash="#site" class="hover">天气查询(语音)</li>
                ...
                <li data-index="14" data-hash="#reser" class="">解梦</li>
                           ...
                           <!--
							...
							<div class="hover" onClick="setTab(0,45)">46.淘宝天猫店铺推广<span class="new"></span></div>
                        </div>
                    </div>
                    !-->
                    <div id="nav_uls">
