...
<div class="top">
  <div class="top1000">
    <div class="top_l"><a href=""><img src="<?php echo C('site_logo');?>" /></a></div>
  </div>
</div>
    ...
    <form action="<?php echo U('Users/checklogin');?>" enctype="multipart/form-data"  onsubmit="return onpost()" id="registerform" name="register" autocomplete="off" method="post">
      ...
      <div class="login">
        ...
        <p class="pass-form-item">
          ...
          <a href="<?php echo U('Index/regpwd');?>" style="position:relative; top:15px; left:10px;">找回密码？</a> </p>
        ...
        <li style=" width:545px;">
          <div class="w545">
            ...
            <div class="products-desc">
              <h3 class="title">什么是<?php echo C('site_title');?></h3>
              <div class="desc"> <?php echo C('site_title');?>是一个集微信公众接口、微信达人、微信资讯，旨在通<br>过方便实用的接口帮助微信营销用户管理提高个人和团队效率的管理产品。
