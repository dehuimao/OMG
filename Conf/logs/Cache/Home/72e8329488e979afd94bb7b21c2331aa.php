   ...
   <head>
    ...
    <div class="header">
        ...
        <div class="w_case_nav">
            <p>为您提供一站式解决方案<br />已服务300+企业<br /><span>万达集团、顺丰优选、江苏移动、温州农业银行、云南大益集团</span><br /><span>贵州茶叶集团等30余家超大型企业<em>选择微企</em></span></p>
        ...
        <div class="company_intro">
            <!--<div class="code">
                <img src="<?php echo RES;?>/images/code_wj.jpg" width="170" height="170" />
                <p>扫一扫<br />即可关注微企</p>
            </div>-->
            <!--游戏娱乐-->
            <ul>
...
　　你可以通过【汉庭酒店】手机客户端在全国150多个城市，超过1000家门店，预订全季酒店、星程酒店、汉庭酒店、海友酒店。</p>
        ...
        <div class="more_company">
            <h3>还有更多企业选择微企</h3>
            <p>
                <img src="<?php echo RES;?>/images/img_case03_01.jpg" width="1440" height="203" />
                <img src="<?php echo RES;?>/images/img_case03_02.jpg" width="1440" height="202" />
                <img src="<?php echo RES;?>/images/img_case03_03.jpg" width="1440" height="203" />
            </p>
        </div>
        <!-- content end-->
        ﻿<!---底部 begin--->
