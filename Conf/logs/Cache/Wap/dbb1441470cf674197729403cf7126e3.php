...
<head>
	...
	<link href="<?php echo RES;?>/css/1144/css/cate65_.css" rel="stylesheet" type="text/css" />

    <link href="<?php echo RES;?>/css/1144/css/iscroll.css" rel="stylesheet" type="text/css" />
    ...
    <script src="<?php echo RES;?>/css/1144/js/iscroll.js" type="text/javascript"></script>
...
<body id="cate65">
        ...
        <div class="banner">
                    ...
                    <ul id="thelist">
					      <?php if(is_array($flash)): $i = 0; $__LIST__ = $flash;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$so): $mod = ($i % 2 );++$i;?><li>
                                ...
                                <a href="<?php echo ($so["url"]); ?>">
                                    ...
                                    <img src="<?php echo ($so["img"]); ?>"></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <div id="nav">
                ...
                <ul id="indicator">
				        <?php if(is_array($flash)): $i = 0; $__LIST__ = $flash;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$so): $mod = ($i % 2 );++$i;?><li class='active'><?php echo ($so["i"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <ul class="mainmenu" id="dd">
	  ...
	  <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: ?>               <?php echo (htmlspecialchars_decode($vo["url"])); endif; ?>">

            <img alt="" src="<?php echo ($vo["img"]); ?>"/><p>
