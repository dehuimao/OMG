...
<link href="<?php echo RES;?>/css/1123/iscroll.css" rel="stylesheet" type="text/css">
<link href="<?php echo RES;?>/css/1123/cate.css" rel="stylesheet" type="text/css">
<style>
</style>
<script src="<?php echo RES;?>/css/1123/iscroll.js" type="text/javascript"></script>
...
<ul id="thelist">
				 ...
				 <?php if(is_array($info[picurls])): foreach($info[picurls] as $key=>$i): ?><li><p></p><img src="<?php echo ($i); ?>" style="width:100%; height:100%"></li><?php endforeach; endif; ?>
...
<script src="<?php echo RES;?>/css/1123/jquery.min.js" type="text/javascript"></script>
