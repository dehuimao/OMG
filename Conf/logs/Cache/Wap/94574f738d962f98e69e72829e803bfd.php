...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/126/reset.css" media="all">
<!-- <link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/126/home-28.css" media="all"> -->
<script type="text/javascript" src="<?php echo RES;?>/css/126/maivl.js"></script>
<script type="text/javascript" src="<?php echo RES;?>/css/116/jQuery.js"></script>
<script type="text/javascript" src="<?php echo RES;?>/css/126/swipe.js"></script>
<script type="text/javascript" src="<?php echo RES;?>/css/126/zepto.js"></script>
    </head>
...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/126/font-awesome.css" media="all">
...
<div class="body">
    ...
    <div style="-webkit-transform:translate3d(0,0,0);">
        <div id="banner_box" class="box_swipe" style="visibility: visible;">
            <ul style="list-style: none; width: <?php echo ($num*433); ?>px; transition: 500ms; -webkit-transition: 500ms; -webkit-transform: translate3d(-866px, 0, 0);">
