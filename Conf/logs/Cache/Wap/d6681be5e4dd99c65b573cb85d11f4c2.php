...
<meta charset="utf-8">
<link href="<?php echo RES;?>/css/1134/cate.css" rel="stylesheet" type="text/css">
<link href="<?php echo RES;?>/css/1134/iscroll.css" rel="stylesheet" type="text/css">
<style></style>
<script src="<?php echo RES;?>/css/1134/iscroll.js" type="text/javascript"></script><script type="text/javascript">var myScroll;
...
<div class="banner">
  <div id="wrapper" style="overflow: hidden;">
    <div id="scroller" style="width: 1222px; -webkit-transition: 0ms; transition: 0ms; -webkit-transform: translate3d(0px, 0px, 0px) scale(1);">
      <ul id="thelist">
       <?php if(is_array($info[picurls])): foreach($info[picurls] as $key=>$i): ?><li><p></p><img src="<?php echo ($i); ?>"></li><?php endforeach; endif; ?>      </ul>
    </div>
  </div>
  <div id="nav">
...
<ul class="mainmenu">
 ...
 <?php if(is_array($cats)): $i = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hostlist): $mod = ($i % 2 );++$i;?><li><a href="<?php if($hostlist['parentid'] == 0): echo U('Store/products',array('token'=>$_GET['token'],'catid'=>$hostlist['id'],'wecha_id'=>$wecha_id,'dining'=>$isDining)); else: echo U('Store/products',array('token'=>$_GET['token'],'catid'=>$hostlist['id'],'wecha_id'=>$wecha_id)); endif; ?>"><img src="<?php echo ($hostlist["logourl"]); ?>">
    <p><b><?php echo ($hostlist["name"]); ?></b><font></font><span></span></p>
...
<script src="<?php echo RES;?>/css/1134/jquery.min.js" type="text/javascript"></script><script>function displayit(n){
	for(i=0;i<4;i++){
		if(i==n){
			var id='menu_list'+n;
