...
<meta charset="utf-8">
<link href="<?php echo RES;?>/css/1125/cate.css" rel="stylesheet" type="text/css">
<link href="<?php echo RES;?>/css/1125/iscroll.css" rel="stylesheet" type="text/css">
<style></style>
<script src="<?php echo RES;?>/css/1125/iscroll.js" type="text/javascript"></script><script type="text/javascript">var myScroll;
...
<body style=""><!--music-->
		</if> <?php if($homeInfo['musicurl'] != false): ?><style>
.btn_music {
...
<div class="banner">
  <div id="wrapper" style="overflow: hidden;">
    <div id="scroller" style="width: 1239px; -webkit-transition: -webkit-transform 0ms; transition: -webkit-transform 0ms; -webkit-transform-origin: 0px 0px; -webkit-transform: translate3d(0px, 0px, 0px) scale(1);">
       <ul id="thelist">
...
<script src="<?php echo RES;?>/css/1125/jquery.min.js" type="text/javascript"></script><script>function displayit(n){
	for(i=0;i<4;i++){
		if(i==n){
			var id='menu_list'+n;
