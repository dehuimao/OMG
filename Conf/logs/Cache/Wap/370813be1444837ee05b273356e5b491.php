...
<link href="./tpl/static/tpl/1101/css/cate.css" rel="stylesheet" type="text/css" />
 <style>
...
<div id="scroller">
<ul id="thelist">
				<?php if(is_array($flashbg)): $i = 0; $__LIST__ = $flashbg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$so): $mod = ($i % 2 );++$i;?><li><p><?php echo ($so["img"]); ?></p><img src="<?php echo ($so["img"]); ?>"></li><?php endforeach; endif; else: echo "" ;endif; ?>
...
<div class="device">
    ...
    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i%9 == 1): ?><div class="swiper-slide">
