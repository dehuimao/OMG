...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/125/pigcms-ui-1-1.css" media="all">
...
<header>
        ...
        <div class="pigcms-content">
            <div class="pigcms-list">
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>" class="pigcms-list-item">
                            ...
                            <div class="pigcms-list-item-box">
                                <div class="pigcms-list-item-line">
                                    <div class="pigcms-list-item-title"><?php echo ($vo["name"]); ?></div>
                                </div>
                            </div>
                        </div>
