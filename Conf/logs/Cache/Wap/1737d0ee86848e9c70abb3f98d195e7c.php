...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/128/reset.css" media="all">
<!-- <link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/128/home-29.css" media="all"> -->
<script type="text/javascript" src="<?php echo RES;?>/css/128/maivl.js"></script>
<script type="text/javascript" src="<?php echo RES;?>/css/116/jQuery.js"></script>
<script type="text/javascript" src="<?php echo RES;?>/css/128/swipe.js"></script>
<script type="text/javascript" src="<?php echo RES;?>/css/128/zepto.js"></script>

        
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/128/font-awesome.css" media="all">
</head>
...
<div class="body">
    ...
    <div style="-webkit-transform:translate3d(0,0,0);">
        <div id="banner_box" class="box_swipe" style="visibility: visible;">
            <ul style="list-style: none; width: <?php echo ($num*433); ?>px; transition: 0ms; -webkit-transition: 0ms; -webkit-transform: translate3d(-433px, 0, 0);">
