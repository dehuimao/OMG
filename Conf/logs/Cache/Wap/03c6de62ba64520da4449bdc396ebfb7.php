...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <link href="<?php echo RES;?>/css/allcss/cate1_0.css" rel="stylesheet" type="text/css" />
...
<a href="<?php echo U('Store/my',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id']));?>"><i></i>用户中心</a>
		...
		<div id="wrapper">
			...
			<div id="scroller">
				...
				<hostlistlist name="flash" id="so">

						<li><p><?php echo ($so["info"]); ?></p><a href="<?php echo ($so["url"]); ?>"><img src="<?php echo ($so["img"]); ?>" /></a></li>
		...
		<div id="nav">
			...
			<li   <?php if($i == 1): ?>class="active"<?php endif; ?>  ><?php echo ($i); ?></li>
                    ...
                    <div class="menubtn">
                       ...
                       <a href="<?php if($hostlist['url'] == ''): echo U('Store/products',array('token' => $_GET['token'], 'catid' => $hostlist['id'], 'wecha_id' => $wecha_id)); else: echo (htmlspecialchars_decode($hostlist["url"])); endif; ?>">
                            ...
                            <div class="menumesg">
                                ...
                                <div class="menutitle"><?php echo ($hostlist["name"]); ?></div>
