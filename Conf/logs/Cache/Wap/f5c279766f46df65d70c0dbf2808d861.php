...
<li><a href="javascript:;">
                ...
                <p>预约患者：<?php echo ($vo['truename']); ?></p>
                <p>联系电话：<?php echo ($vo['utel']); ?></p>
                <p>预约科室 ：<?php echo ($vo['yyks']); ?></p>
                <p>预约专家 ：<?php echo ($vo['yyzj']); ?></p>
                <p>预约病种 ：<?php echo ($vo['yybz']); ?></p>
                <p>提交时间：<?php echo (date('Y年m月d日',$vo['booktime'])); ?></p>
                </a><div class="footReturn"><a href="javascript:;"></a>
<?php if($vo['remate'] == 0): ?><a id="" style="color:#fff;" class="submit" href="<?php echo U('Medical/del',array('token'=>$token,'wecha_id'=>$wecha_id,'iid'=>$vo['iid'],'rid'=>$vo['rid']));?>">删除订单</a><?php endif; ?>
