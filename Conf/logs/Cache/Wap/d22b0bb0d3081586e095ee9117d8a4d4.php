...
<!-- <link href="<?php echo RES;?>/css/134/cate21_.css" rel="stylesheet" type="text/css"> -->
<link href="<?php echo RES;?>/css/134/iscroll.css" rel="stylesheet" type="text/css">

<script src="<?php echo RES;?>/css/134/jquery.min.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/134/idangerous.swiper.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/134/iscroll.js" type="text/javascript"></script>
...
<div class="cname"><a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>"><img src="<?php echo ($vo["img"]); ?>"><p><?php echo ($vo["name"]); ?></p></a></div>
<ul>


<li>
<?php if(is_array($vo['sub'])): $i = 0; $__LIST__ = $vo['sub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;?><a href="<?php if($res['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$res['id'],'token'=>$res['token'])); else: echo (htmlspecialchars_decode($res["url"])); endif; ?>"><?php echo ($res["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
<div class="clr"></div>
</li>
</ul>
