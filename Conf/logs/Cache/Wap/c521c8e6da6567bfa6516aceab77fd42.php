...
<meta name="format-detection" content="telephone=no">
			...
			<style>
				...
				#GameLayerBG {background:url('./tpl/static/applegame/autumn/game_bg.jpg')}
				.t1,.t2,.t3,.t4,.t5 { background-size:auto 100%;background-image:url(./tpl/static/applegame/autumn/icon.png);}
...
<body onload="init()">
	...
	//结束后调用 _gameScore 点中的数量
		...
		$.ajax({
			url: "<?php echo U('Autumn/gameOver',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id'],'id'=>intval($_GET['id'])));?>",
			type: "post",
			data: {"num":_gameScore},
		...
		l.style.display = 'block';
		window.shareData.tTitle = '哈哈，中秋佳节，吃月饼大赛。我居然得了'+_gameScore+'分!不服来挑战！！！'
	...
	function replayBtn(){
		location.href="<?php echo U('Autumn/index',array('token'=>$_GET['token'],'id'=>intval($_GET['id']),'wecha_id'=>$_GET['wecha_id']));?>";
		//gameRestart();
		//hideGameScoreLayer();
	}
	...
	function shareText( score ){
		...
		return '哈哈，中秋佳节，吃月饼大赛。我居然得了'+score+'分！<br/>';
	}
...
<!--	游戏结束	-->
	<div style="display:none;background:url(./tpl/static/applegame/autumn/gameoverbg.jpg) no-repeat center 0 #031448;background-size:100%;" id="GameScoreLayer" class="BBOX SHADE">
		<div style="padding:40% 5%;">
			...
			<div id="GameScoreLayer-btn" class="BOX">
				<div style="width:142px;height:48px;" class="btn BOX-S" onclick="replayBtn()"><img src="./tpl/static/applegame/autumn/btn_again.png" width="100%" /></div>&nbsp;
				<div style="width:142px;height:48px;" class="btn BOX-S" onclick="share()"><img src="./tpl/static/applegame/autumn/btn_share.png" width="100%" /></div>&nbsp;
				
			</div>

			
			<div id="GameScoreLayer-msg" class="BOX" style="display:none"><?php echo ($aginfo); ?> &nbsp; <a href="<?php echo U('AppleGame/index',array('token'=>$_GET['token'],'id'=>intval($_GET['id']),'wecha_id'=>$_GET['wecha_id']));?>" style="color:blue;text-decoration:none;">查看排名</a></div>
			<br/>
		</div>
	</div>
