...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/template/home-32.css" media="all" />
...
<script src="<?php echo RES;?>/css/1137/iscroll.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/js/yuesh/iscroll.js" type="text/javascript"></script>
...
<body>
<?php if($dh['animation'] != false): ?><iframe id="iframe_screen" src="./tpl/Wap/default/Index_an<?php echo ($dh["animation"]); ?>.html" frameborder="0"></iframe><?php endif; ?> <?php if($homeInfo['musicurl'] != false): ?><style>
.btn_music {
