...
<div class="Listpage">
    ...
    <div id="todayList" >
        <ul class="chatPanel">
<?php if(is_array($classify)): $i = 0; $__LIST__ = $classify;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="media mediaFullText">

<a href="<?php echo U('Business/classify_item',array('token'=>$token,'wecha_id'=>$wecha_id,'type'=>$vo['type'],'bid'=>$vo['bid_id'],'mid'=>$vo['mid']));?>">
                    ...
                    <?php if($vo['desc_pic'] != ''): ?><div class="mediaImg"><img src="<?php echo ($vo['desc_pic']); ?>"></div><?php endif; ?>
                        <div class="mediaContent mediaContentP">
                            <p>
                               <?php echo (mb_substr(strip_tags(html_entity_decode($vo['main_desc'])),0,89,'utf-8')); ?>...
                            </p>
                        </div>
