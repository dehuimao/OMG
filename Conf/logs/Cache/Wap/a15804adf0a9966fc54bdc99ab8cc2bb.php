...
<meta charset="utf-8">
<link href="./tpl/static/tpl/186/css/cate.css" rel="stylesheet" type="text/css" />
...
<div class="clr"></div>
 ...
 <div id="insert1" ></div>
<ul  class="mainmenu">
	<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>" ><img src="<?php echo ($vo["img"]); ?>" /><p><b><?php echo ($vo["name"]); ?></b><span><?php echo ($vo["info"]); ?></span><em></em></p></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
