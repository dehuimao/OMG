  ...
  <nav class="nav_for_list_ul">
    ...
    <div class="ofh">
      ...
      <ul>
		...
		<?php $__FOR_START_12895__=1;$__FOR_END_12895__=count($info);for($i=$__FOR_START_12895__;$i < $__FOR_END_12895__;$i+=1){ ?><li <?php if($i == 1): ?>class="on"<?php endif; ?>></li><?php } ?>
