...
<body id="hotelsmore" >
<div class="qiandaobanner"><?php if($set['headpic']): ?><img src="<?php echo ($set['headpic']); ?>" ><?php else: ?><img src="<?php echo RES;?>/css/style/images/RTqs2yHIc9.jpg" ><?php endif; ?></div>
...
window.shareData = {  
            ...
            "moduleID":"0",
            "imgUrl": "", 
            "sendFriendLink": "<?php echo ($f_siteUrl); echo U('Host/index',array('token'=>$token));?>",
            "tTitle": "预定",
            "tContent": ""
};
</script>
