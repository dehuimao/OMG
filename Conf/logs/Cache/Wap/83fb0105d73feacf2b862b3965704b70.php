...
<!-- <link href="<?php echo RES;?>/css/132/cate13_.css" rel="stylesheet" type="text/css"> -->
<link href="<?php echo RES;?>/css/132/iscroll.css" rel="stylesheet" type="text/css">

<script src="<?php echo RES;?>/css/132/jquery.min.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/132/idangerous.swiper.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/132/iscroll.js" type="text/javascript"></script>
...
<div id="scroller" style="width: <?php echo ($num*1349); ?>px; -webkit-transition: 0ms; transition: 0ms; -webkit-transform: translate3d(-2698px, 0px, 0px) scale(1);">
<ul id="thelist">
...
<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!-- <?php var_dump($vo); ?> -->
<div class="Category">
<div class="cname"><a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>" class="more"><!-- 查看更多 --></a><?php echo ($vo["name"]); ?></div>
    <div class="clist swiper-container clist<?php echo ($vo['key']); ?>">
...
<ul>
    ...
    <?php if(is_array($vo['sub'])): $i = 0; $__LIST__ = $vo['sub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;?><li><a href="<?php if($res['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$res['id'],'token'=>$res['token'])); else: echo (htmlspecialchars_decode($res["url"])); endif; ?>"><div><img src="<?php echo ($res["img"]); ?>"></div><span><?php echo ($res["name"]); ?></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>    
 ...
 <script>
$(function(){
new Swiper('.clist'+<?php echo ($vo['key']); ?>,{
 followFinger:false
  });
});
</script>
