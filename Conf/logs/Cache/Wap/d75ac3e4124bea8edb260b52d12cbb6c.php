...
<!-- <link href="<?php echo RES;?>/css/133/cate20_.css" rel="stylesheet" type="text/css"> -->
<link href="<?php echo RES;?>/css/133/iscroll.css" rel="stylesheet" type="text/css">

<script src="<?php echo RES;?>/css/133/jquery.min.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/133/idangerous.swiper.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/133/iscroll.js" type="text/javascript"></script>
...
<a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>"><div class="cname"><img src="<?php echo ($vo["img"]); ?>"><?php echo ($vo["name"]); ?></div></a>
<ul>
<?php
$i=1; $lastItem=end($vo['sub']); foreach ($vo['sub'] as $item){ if ($i%4==1){ echo '<li>'; } $url=$item['url']?htmlspecialchars_decode($item['url']):U('Wap/Index/lists',array('classid'=>$item['id'],'token'=>$item['token'])); echo '<a href="'.$url.'">'.$item['name'].'</a>'; if ($i%4==0||$lastItem['id']==$item['id']){ echo '</li>'; } $i++; } ?>  
