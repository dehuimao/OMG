...
<link href="./tpl/static/tpl/1109/css/cate.css" rel="stylesheet" type="text/css" />
...
<div class="device">
    ...
    <div class="swiper-container">
      ...
      <div class="swiper-wrapper">
           ...
           <?php if(is_array($cats)): $i = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hostlist): $mod = ($i % 2 );++$i; if($i%9 == 1): ?><div class="swiper-slide">
