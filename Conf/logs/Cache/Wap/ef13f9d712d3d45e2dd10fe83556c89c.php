...
<link href="./tpl/static/tpl/1100/css/cate.css" rel="stylesheet" type="text/css" />
...
<ul id="thelist">
    ...
    <?php if(is_array($flashbg)): $i = 0; $__LIST__ = $flashbg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$so): $mod = ($i % 2 );++$i;?><li><p></p><img src="<?php echo ($so["img"]); ?>" style="width:100%;height:100%" /></li><?php endforeach; endif; else: echo "" ;endif; ?>
